...
k3s ctr images import images/appscode-images-milvus-2.6.9.tar
k3s ctr images import images/appscode-images-milvus-3.0.0.tar
...
k3s ctr images import images/kubedb-hanadb-coordinator-v0.7.0-rc.2.tar
