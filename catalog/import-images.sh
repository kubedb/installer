...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-hanadb-coordinator-v0.5.0-rc.1.tar $IMAGE_REGISTRY/kubedb/hanadb-coordinator:v0.5.0-rc.1
