...
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-images-milvus-3.0.0.tar $IMAGE_REGISTRY/appscode-images/milvus:3.0.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-hanadb-coordinator-v0.7.0-rc.2.tar $IMAGE_REGISTRY/kubedb/hanadb-coordinator:v0.7.0-rc.2
