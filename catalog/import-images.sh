...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-db2-coordinator-v0.6.0.tar $IMAGE_REGISTRY/kubedb/db2-coordinator:v0.6.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-hanadb-coordinator-v0.5.0.tar $IMAGE_REGISTRY/kubedb/hanadb-coordinator:v0.5.0
