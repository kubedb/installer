...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-db2-coordinator-v0.6.0-rc.2.tar $IMAGE_REGISTRY/kubedb/db2-coordinator:v0.6.0-rc.2
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-hanadb-coordinator-v0.5.0-rc.2.tar $IMAGE_REGISTRY/kubedb/hanadb-coordinator:v0.5.0-rc.2
