...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mariadb-archiver-v0.27.0-rc.2_10.5.23-focal.tar $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.27.0-rc.2_10.5.23-focal
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mariadb-archiver-v0.27.0-rc.2_10.6.16-focal.tar $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.27.0-rc.2_10.6.16-focal
