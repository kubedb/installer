...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mariadb-archiver-v0.21.0-rc.1_10.10.7-jammy.tar $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.21.0-rc.1_10.10.7-jammy
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mariadb-archiver-v0.21.0-rc.1_10.11.6-jammy.tar $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.21.0-rc.1_10.11.6-jammy
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mariadb-archiver-v0.21.0-rc.1_10.4.32-focal.tar $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.21.0-rc.1_10.4.32-focal
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mariadb-archiver-v0.21.0-rc.1_10.5.23-focal.tar $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.21.0-rc.1_10.5.23-focal
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mariadb-archiver-v0.21.0-rc.1_10.6.16-focal.tar $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.21.0-rc.1_10.6.16-focal
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mariadb-archiver-v0.21.0-rc.1_11.0.4-jammy.tar $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.21.0-rc.1_11.0.4-jammy
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mariadb-archiver-v0.21.0-rc.1_11.1.3-jammy.tar $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.21.0-rc.1_11.1.3-jammy
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mariadb-archiver-v0.21.0-rc.1_11.2.2-jammy.tar $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.21.0-rc.1_11.2.2-jammy
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mariadb-coordinator-v0.41.0-rc.1.tar $IMAGE_REGISTRY/kubedb/mariadb-coordinator:v0.41.0-rc.1
