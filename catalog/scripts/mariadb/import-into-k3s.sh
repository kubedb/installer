...
k3s ctr images import images/kubedb-mariadb-archiver-v0.13.0_10.10.7-jammy.tar
k3s ctr images import images/kubedb-mariadb-archiver-v0.13.0_10.11.6-jammy.tar
k3s ctr images import images/kubedb-mariadb-archiver-v0.13.0_10.4.32-focal.tar
k3s ctr images import images/kubedb-mariadb-archiver-v0.13.0_10.5.23-focal.tar
k3s ctr images import images/kubedb-mariadb-archiver-v0.13.0_10.6.16-focal.tar
k3s ctr images import images/kubedb-mariadb-archiver-v0.13.0_11.0.4-jammy.tar
k3s ctr images import images/kubedb-mariadb-archiver-v0.13.0_11.1.3-jammy.tar
k3s ctr images import images/kubedb-mariadb-archiver-v0.13.0_11.2.2-jammy.tar
k3s ctr images import images/kubedb-mariadb-coordinator-v0.33.0.tar
