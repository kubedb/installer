...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.25.0-rc.1_10.10.7-jammy $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.25.0-rc.1_10.10.7-jammy
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.25.0-rc.1_10.11.6-jammy $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.25.0-rc.1_10.11.6-jammy
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.25.0-rc.1_10.4.32-focal $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.25.0-rc.1_10.4.32-focal
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.25.0-rc.1_10.5.23-focal $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.25.0-rc.1_10.5.23-focal
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.25.0-rc.1_10.6.16-focal $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.25.0-rc.1_10.6.16-focal
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.25.0-rc.1_11.0.4-jammy $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.25.0-rc.1_11.0.4-jammy
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.25.0-rc.1_11.1.3-jammy $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.25.0-rc.1_11.1.3-jammy
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.25.0-rc.1_11.2.2-jammy $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.25.0-rc.1_11.2.2-jammy
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-coordinator:v0.45.0-rc.1 $IMAGE_REGISTRY/kubedb/mariadb-coordinator:v0.45.0-rc.1
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-migrator-cli:v0.5.0-rc.1 $IMAGE_REGISTRY/kubedb/mariadb-migrator-cli:v0.5.0-rc.1
