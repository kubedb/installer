...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.20.0-rc.0_10.4.32-focal images/kubedb-mariadb-archiver-v0.20.0-rc.0_10.4.32-focal.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.20.0-rc.0_10.5.23-focal images/kubedb-mariadb-archiver-v0.20.0-rc.0_10.5.23-focal.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.20.0-rc.0_10.6.16-focal images/kubedb-mariadb-archiver-v0.20.0-rc.0_10.6.16-focal.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.20.0-rc.0_11.0.4-jammy images/kubedb-mariadb-archiver-v0.20.0-rc.0_11.0.4-jammy.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.20.0-rc.0_11.1.3-jammy images/kubedb-mariadb-archiver-v0.20.0-rc.0_11.1.3-jammy.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.20.0-rc.0_11.2.2-jammy images/kubedb-mariadb-archiver-v0.20.0-rc.0_11.2.2-jammy.tar
