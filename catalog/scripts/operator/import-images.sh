...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-csi-snapshotter-plugin-v0.14.0.tar $IMAGE_REGISTRY/kubedb/mysql-csi-snapshotter-plugin:v0.14.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-csi-snapshotter-plugin-v0.14.0.tar $IMAGE_REGISTRY/kubedb/postgres-csi-snapshotter-plugin:v0.14.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-zookeeper-restic-plugin-v0.9.0.tar $IMAGE_REGISTRY/kubedb/zookeeper-restic-plugin:v0.9.0
