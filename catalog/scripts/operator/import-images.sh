...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-dashboard-restic-plugin-v0.10.0.tar $IMAGE_REGISTRY/kubedb/dashboard-restic-plugin:v0.10.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-csi-snapshotter-plugin-v0.13.0.tar $IMAGE_REGISTRY/kubedb/mysql-csi-snapshotter-plugin:v0.13.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-csi-snapshotter-plugin-v0.13.0.tar $IMAGE_REGISTRY/kubedb/postgres-csi-snapshotter-plugin:v0.13.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-provider-aws-v0.14.0.tar $IMAGE_REGISTRY/kubedb/provider-aws:v0.14.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-provider-azure-v0.14.0.tar $IMAGE_REGISTRY/kubedb/provider-azure:v0.14.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-provider-gcp-v0.14.0.tar $IMAGE_REGISTRY/kubedb/provider-gcp:v0.14.0
