...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-elasticsearch-restic-plugin-v0.19.0.tar $IMAGE_REGISTRY/kubedb/elasticsearch-restic-plugin:v0.19.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-gitops-v0.4.0.tar $IMAGE_REGISTRY/kubedb/kubedb-gitops:v0.4.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-kibana-v0.32.0.tar $IMAGE_REGISTRY/kubedb/kubedb-kibana:v0.32.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-manifest-plugin-v0.19.0.tar $IMAGE_REGISTRY/kubedb/kubedb-manifest-plugin:v0.19.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mssqlserver-walg-plugin-v0.10.0.tar $IMAGE_REGISTRY/kubedb/mssqlserver-walg-plugin:v0.10.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-csi-snapshotter-plugin-v0.17.0.tar $IMAGE_REGISTRY/kubedb/postgres-csi-snapshotter-plugin:v0.17.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-provider-aws-v0.17.0.tar $IMAGE_REGISTRY/kubedb/provider-aws:v0.17.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-provider-azure-v0.17.0.tar $IMAGE_REGISTRY/kubedb/provider-azure:v0.17.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-provider-gcp-v0.17.0.tar $IMAGE_REGISTRY/kubedb/provider-gcp:v0.17.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-zookeeper-restic-plugin-v0.12.0.tar $IMAGE_REGISTRY/kubedb/zookeeper-restic-plugin:v0.12.0
