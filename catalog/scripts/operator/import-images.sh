...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-elasticsearch-restic-plugin-v0.22.0.tar $IMAGE_REGISTRY/kubedb/elasticsearch-restic-plugin:v0.22.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-gitops-v0.7.0.tar $IMAGE_REGISTRY/kubedb/kubedb-gitops:v0.7.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-kibana-v0.35.0.tar $IMAGE_REGISTRY/kubedb/kubedb-kibana:v0.35.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-manifest-plugin-v0.22.0.tar $IMAGE_REGISTRY/kubedb/kubedb-manifest-plugin:v0.22.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-provider-gcp-v0.20.0.tar $IMAGE_REGISTRY/kubedb/provider-gcp:v0.20.0
