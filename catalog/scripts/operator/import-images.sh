...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-autoscaler-v0.52.0-rc.2.tar $IMAGE_REGISTRY/kubedb/kubedb-autoscaler:v0.52.0-rc.2
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-courier-v0.7.0-rc.2.tar $IMAGE_REGISTRY/kubedb/kubedb-courier:v0.7.0-rc.2
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-crd-manager-v0.22.0-rc.2.tar $IMAGE_REGISTRY/kubedb/kubedb-crd-manager:v0.22.0-rc.2
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-gitops-v0.15.0-rc.2.tar $IMAGE_REGISTRY/kubedb/kubedb-gitops:v0.15.0-rc.2
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-kibana-v0.43.0-rc.2.tar $IMAGE_REGISTRY/kubedb/kubedb-kibana:v0.43.0-rc.2
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-manifest-plugin-v0.30.0-rc.2.tar $IMAGE_REGISTRY/kubedb/kubedb-manifest-plugin:v0.30.0-rc.2
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-ops-manager-v0.54.0-rc.2.tar $IMAGE_REGISTRY/kubedb/kubedb-ops-manager:v0.54.0-rc.2
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-provisioner-v0.67.0-rc.2.tar $IMAGE_REGISTRY/kubedb/kubedb-provisioner:v0.67.0-rc.2
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-schema-manager-v0.43.0-rc.2.tar $IMAGE_REGISTRY/kubedb/kubedb-schema-manager:v0.43.0-rc.2
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-ui-server-v0.43.0-rc.2.tar $IMAGE_REGISTRY/kubedb/kubedb-ui-server:v0.43.0-rc.2
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-verifier-v0.18.0-rc.2.tar $IMAGE_REGISTRY/kubedb/kubedb-verifier:v0.18.0-rc.2
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-webhook-server-v0.43.0-rc.2.tar $IMAGE_REGISTRY/kubedb/kubedb-webhook-server:v0.43.0-rc.2
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mariadb-csi-snapshotter-plugin-v0.27.0-rc.2.tar $IMAGE_REGISTRY/kubedb/mariadb-csi-snapshotter-plugin:v0.27.0-rc.2
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mariadb-restic-plugin-v0.25.0-rc.2_10.11.6-jammy.tar $IMAGE_REGISTRY/kubedb/mariadb-restic-plugin:v0.25.0-rc.2_10.11.6-jammy
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mongodb-restic-plugin-v0.30.0-rc.2_5.0.15.tar $IMAGE_REGISTRY/kubedb/mongodb-restic-plugin:v0.30.0-rc.2_5.0.15
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mongodb-restic-plugin-v0.30.0-rc.2_5.0.3.tar $IMAGE_REGISTRY/kubedb/mongodb-restic-plugin:v0.30.0-rc.2_5.0.3
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mongodb-restic-plugin-v0.30.0-rc.2_6.0.5.tar $IMAGE_REGISTRY/kubedb/mongodb-restic-plugin:v0.30.0-rc.2_6.0.5
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mongodb-restic-plugin-v0.30.0-rc.2_8.0.3.tar $IMAGE_REGISTRY/kubedb/mongodb-restic-plugin:v0.30.0-rc.2_8.0.3
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mssqlserver-walg-plugin-v0.21.0-rc.2.tar $IMAGE_REGISTRY/kubedb/mssqlserver-walg-plugin:v0.21.0-rc.2
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-csi-snapshotter-plugin-v0.28.0-rc.2.tar $IMAGE_REGISTRY/kubedb/mysql-csi-snapshotter-plugin:v0.28.0-rc.2
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-restic-plugin-v0.30.0-rc.2_5.7.25.tar $IMAGE_REGISTRY/kubedb/mysql-restic-plugin:v0.30.0-rc.2_5.7.25
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-restic-plugin-v0.30.0-rc.2_8.0.21.tar $IMAGE_REGISTRY/kubedb/mysql-restic-plugin:v0.30.0-rc.2_8.0.21
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-restic-plugin-v0.30.0-rc.2_8.0.3.tar $IMAGE_REGISTRY/kubedb/mysql-restic-plugin:v0.30.0-rc.2_8.0.3
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-restic-plugin-v0.30.0-rc.2_16.4.tar $IMAGE_REGISTRY/kubedb/postgres-restic-plugin:v0.30.0-rc.2_16.4
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-restic-plugin-v0.30.0-rc.2_17.2.tar $IMAGE_REGISTRY/kubedb/postgres-restic-plugin:v0.30.0-rc.2_17.2
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-restic-plugin-v0.30.0-rc.2_18.2.tar $IMAGE_REGISTRY/kubedb/postgres-restic-plugin:v0.30.0-rc.2_18.2
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-provider-aws-v0.28.0-rc.2.tar $IMAGE_REGISTRY/kubedb/provider-aws:v0.28.0-rc.2
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-provider-azure-v0.28.0-rc.2.tar $IMAGE_REGISTRY/kubedb/provider-azure:v0.28.0-rc.2
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-provider-gcp-v0.28.0-rc.2.tar $IMAGE_REGISTRY/kubedb/provider-gcp:v0.28.0-rc.2
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-qdrant-restic-plugin-v0.3.0-rc.2.tar $IMAGE_REGISTRY/kubedb/qdrant-restic-plugin:v0.3.0-rc.2
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-xtrabackup-restic-plugin-v0.15.0-rc.2_8.2.0.tar $IMAGE_REGISTRY/kubedb/xtrabackup-restic-plugin:v0.15.0-rc.2_8.2.0
