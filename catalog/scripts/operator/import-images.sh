...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mariadb-csi-snapshotter-plugin-v0.13.0-rc.1.tar $IMAGE_REGISTRY/kubedb/mariadb-csi-snapshotter-plugin:v0.13.0-rc.1
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mariadb-restic-plugin-v0.11.0-rc.1.tar $IMAGE_REGISTRY/kubedb/mariadb-restic-plugin:v0.11.0-rc.1
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mongodb-csi-snapshotter-plugin-v0.14.0-rc.1.tar $IMAGE_REGISTRY/kubedb/mongodb-csi-snapshotter-plugin:v0.14.0-rc.1
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-csi-snapshotter-plugin-v0.14.0-rc.1.tar $IMAGE_REGISTRY/kubedb/mysql-csi-snapshotter-plugin:v0.14.0-rc.1
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-csi-snapshotter-plugin-v0.14.0-rc.1.tar $IMAGE_REGISTRY/kubedb/postgres-csi-snapshotter-plugin:v0.14.0-rc.1
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-provider-aws-v0.14.0-rc.1.tar $IMAGE_REGISTRY/kubedb/provider-aws:v0.14.0-rc.1
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-provider-azure-v0.14.0-rc.1.tar $IMAGE_REGISTRY/kubedb/provider-azure:v0.14.0-rc.1
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-provider-gcp-v0.14.0-rc.1.tar $IMAGE_REGISTRY/kubedb/provider-gcp:v0.14.0-rc.1
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-zookeeper-restic-plugin-v0.9.0-rc.1.tar $IMAGE_REGISTRY/kubedb/zookeeper-restic-plugin:v0.9.0-rc.1
