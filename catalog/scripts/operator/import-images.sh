...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-elasticsearch-restic-plugin-v0.23.0-rc.0.tar $IMAGE_REGISTRY/kubedb/elasticsearch-restic-plugin:v0.23.0-rc.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-autoscaler-v0.45.0-rc.0.tar $IMAGE_REGISTRY/kubedb/kubedb-autoscaler:v0.45.0-rc.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-crd-manager-v0.15.0-rc.0.tar $IMAGE_REGISTRY/kubedb/kubedb-crd-manager:v0.15.0-rc.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-gitops-v0.8.0-rc.0.tar $IMAGE_REGISTRY/kubedb/kubedb-gitops:v0.8.0-rc.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-kibana-v0.36.0-rc.0.tar $IMAGE_REGISTRY/kubedb/kubedb-kibana:v0.36.0-rc.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-manifest-plugin-v0.23.0-rc.0.tar $IMAGE_REGISTRY/kubedb/kubedb-manifest-plugin:v0.23.0-rc.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-ops-manager-v0.47.0-rc.0.tar $IMAGE_REGISTRY/kubedb/kubedb-ops-manager:v0.47.0-rc.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mssqlserver-walg-plugin-v0.14.0-rc.0.tar $IMAGE_REGISTRY/kubedb/mssqlserver-walg-plugin:v0.14.0-rc.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-csi-snapshotter-plugin-v0.21.0-rc.0.tar $IMAGE_REGISTRY/kubedb/mysql-csi-snapshotter-plugin:v0.21.0-rc.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-csi-snapshotter-plugin-v0.21.0-rc.0.tar $IMAGE_REGISTRY/kubedb/postgres-csi-snapshotter-plugin:v0.21.0-rc.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-restic-plugin-v0.23.0-rc.0_16.1.tar $IMAGE_REGISTRY/kubedb/postgres-restic-plugin:v0.23.0-rc.0_16.1
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-provider-aws-v0.21.0-rc.0.tar $IMAGE_REGISTRY/kubedb/provider-aws:v0.21.0-rc.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-provider-azure-v0.21.0-rc.0.tar $IMAGE_REGISTRY/kubedb/provider-azure:v0.21.0-rc.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-provider-gcp-v0.21.0-rc.0.tar $IMAGE_REGISTRY/kubedb/provider-gcp:v0.21.0-rc.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-redis-restic-plugin-v0.23.0-rc.0.tar $IMAGE_REGISTRY/kubedb/redis-restic-plugin:v0.23.0-rc.0
