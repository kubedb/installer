...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-ops-manager-v0.50.1.tar $IMAGE_REGISTRY/kubedb/kubedb-ops-manager:v0.50.1
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-provisioner-v0.63.1.tar $IMAGE_REGISTRY/kubedb/kubedb-provisioner:v0.63.1
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-provider-aws-v0.24.0.tar $IMAGE_REGISTRY/kubedb/provider-aws:v0.24.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-provider-azure-v0.24.0.tar $IMAGE_REGISTRY/kubedb/provider-azure:v0.24.0
