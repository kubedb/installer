...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/dashboard-restic-plugin:v0.8.0 images/kubedb-dashboard-restic-plugin-v0.8.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/elasticsearch-restic-plugin:v0.13.0 images/kubedb-elasticsearch-restic-plugin-v0.13.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-kibana:v0.26.0 images/kubedb-kubedb-kibana-v0.26.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-manifest-plugin:v0.13.0 images/kubedb-kubedb-manifest-plugin-v0.13.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-csi-snapshotter-plugin:v0.10.0 images/kubedb-mariadb-csi-snapshotter-plugin-v0.10.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-restic-plugin:v0.8.0 images/kubedb-mariadb-restic-plugin-v0.8.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mongodb-csi-snapshotter-plugin:v0.11.0 images/kubedb-mongodb-csi-snapshotter-plugin-v0.11.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/zookeeper-restic-plugin:v0.6.0 images/kubedb-zookeeper-restic-plugin-v0.6.0.tar
