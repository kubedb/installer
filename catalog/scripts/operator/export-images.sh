...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-gitops:v0.2.0 images/kubedb-kubedb-gitops-v0.2.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-kibana:v0.30.0 images/kubedb-kubedb-kibana-v0.30.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-manifest-plugin:v0.17.0 images/kubedb-kubedb-manifest-plugin-v0.17.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-csi-snapshotter-plugin:v0.14.0 images/kubedb-mariadb-csi-snapshotter-plugin-v0.14.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-restic-plugin:v0.12.0 images/kubedb-mariadb-restic-plugin-v0.12.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mongodb-csi-snapshotter-plugin:v0.15.0 images/kubedb-mongodb-csi-snapshotter-plugin-v0.15.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-csi-snapshotter-plugin:v0.15.0 images/kubedb-mysql-csi-snapshotter-plugin-v0.15.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/provider-gcp:v0.15.0 images/kubedb-provider-gcp-v0.15.0.tar
