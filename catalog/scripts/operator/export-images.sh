...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/cassandra-medusa-plugin:v0.7.0 images/kubedb-cassandra-medusa-plugin-v0.7.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/dashboard-restic-plugin:v0.18.0 images/kubedb-dashboard-restic-plugin-v0.18.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/elasticsearch-restic-plugin:v0.23.0 images/kubedb-elasticsearch-restic-plugin-v0.23.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-gitops:v0.8.0 images/kubedb-kubedb-gitops-v0.8.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/migrator-operator:v0.1.0-rc.0 images/kubedb-migrator-operator-v0.1.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-csi-snapshotter-plugin:v0.21.0 images/kubedb-postgres-csi-snapshotter-plugin-v0.21.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/provider-aws:v0.21.0 images/kubedb-provider-aws-v0.21.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/provider-azure:v0.21.0 images/kubedb-provider-azure-v0.21.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/provider-gcp:v0.21.0 images/kubedb-provider-gcp-v0.21.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/zookeeper-restic-plugin:v0.16.0 images/kubedb-zookeeper-restic-plugin-v0.16.0.tar
