...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-ops-manager:v0.50.1 images/kubedb-kubedb-ops-manager-v0.50.1.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-provisioner:v0.63.1 images/kubedb-kubedb-provisioner-v0.63.1.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/provider-aws:v0.24.0 images/kubedb-provider-aws-v0.24.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/provider-azure:v0.24.0 images/kubedb-provider-azure-v0.24.0.tar
