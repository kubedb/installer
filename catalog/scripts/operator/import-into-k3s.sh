...
k3s ctr images import images/kubedb-cassandra-medusa-plugin-v0.6.0.tar
...
k3s ctr images import images/kubedb-elasticsearch-restic-plugin-v0.22.0.tar
...
k3s ctr images import images/kubedb-kubedb-gitops-v0.7.0.tar
k3s ctr images import images/kubedb-kubedb-kibana-v0.35.0.tar
k3s ctr images import images/kubedb-kubedb-manifest-plugin-v0.22.0.tar
...
k3s ctr images import images/kubedb-provider-gcp-v0.20.0.tar
