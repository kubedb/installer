...
k3s ctr images import images/kubedb-dashboard-restic-plugin-v0.8.0.tar
k3s ctr images import images/kubedb-elasticsearch-restic-plugin-v0.13.0.tar
...
k3s ctr images import images/kubedb-zookeeper-restic-plugin-v0.6.0.tar
