...
k3s ctr images import images/kubedb-mariadb-csi-snapshotter-plugin-v0.13.0-rc.1.tar
k3s ctr images import images/kubedb-mariadb-restic-plugin-v0.11.0-rc.1.tar
k3s ctr images import images/kubedb-mongodb-csi-snapshotter-plugin-v0.14.0-rc.1.tar
k3s ctr images import images/kubedb-mssqlserver-walg-plugin-v0.0.1.tar
k3s ctr images import images/kubedb-mysql-csi-snapshotter-plugin-v0.14.0-rc.1.tar
k3s ctr images import images/kubedb-postgres-csi-snapshotter-plugin-v0.14.0-rc.1.tar
k3s ctr images import images/kubedb-postgres-restic-plugin-v0.16.0-rc.1_16.1.tar
k3s ctr images import images/kubedb-provider-aws-v0.14.0-rc.1.tar
k3s ctr images import images/kubedb-provider-azure-v0.14.0-rc.1.tar
k3s ctr images import images/kubedb-provider-gcp-v0.14.0-rc.1.tar
k3s ctr images import images/kubedb-redis-restic-plugin-v0.16.0-rc.1.tar
k3s ctr images import images/kubedb-zookeeper-restic-plugin-v0.9.0-rc.1.tar
