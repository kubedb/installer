...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/shuvokumarmondal/solr-plugin:multi-backend-v3.0_linux_amd64 $IMAGE_REGISTRY/shuvokumarmondal/solr-plugin:multi-backend-v3.0_linux_amd64
