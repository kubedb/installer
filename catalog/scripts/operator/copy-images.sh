...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/dashboard-restic-plugin:v0.10.0 $IMAGE_REGISTRY/kubedb/dashboard-restic-plugin:v0.10.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-csi-snapshotter-plugin:v0.13.0 $IMAGE_REGISTRY/kubedb/mysql-csi-snapshotter-plugin:v0.13.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-csi-snapshotter-plugin:v0.13.0 $IMAGE_REGISTRY/kubedb/postgres-csi-snapshotter-plugin:v0.13.0
