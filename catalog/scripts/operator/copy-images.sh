...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-csi-snapshotter-plugin:v0.15.0 $IMAGE_REGISTRY/kubedb/mysql-csi-snapshotter-plugin:v0.15.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/provider-gcp:v0.15.0 $IMAGE_REGISTRY/kubedb/provider-gcp:v0.15.0
