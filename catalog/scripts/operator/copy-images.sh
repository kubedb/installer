...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-csi-snapshotter-plugin:v0.13.0-rc.1 $IMAGE_REGISTRY/kubedb/mariadb-csi-snapshotter-plugin:v0.13.0-rc.1
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-restic-plugin:v0.11.0-rc.1 $IMAGE_REGISTRY/kubedb/mariadb-restic-plugin:v0.11.0-rc.1
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mongodb-csi-snapshotter-plugin:v0.14.0-rc.1 $IMAGE_REGISTRY/kubedb/mongodb-csi-snapshotter-plugin:v0.14.0-rc.1
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-csi-snapshotter-plugin:v0.14.0-rc.1 $IMAGE_REGISTRY/kubedb/mysql-csi-snapshotter-plugin:v0.14.0-rc.1
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-csi-snapshotter-plugin:v0.14.0-rc.1 $IMAGE_REGISTRY/kubedb/postgres-csi-snapshotter-plugin:v0.14.0-rc.1
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/provider-aws:v0.14.0-rc.1 $IMAGE_REGISTRY/kubedb/provider-aws:v0.14.0-rc.1
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/provider-azure:v0.14.0-rc.1 $IMAGE_REGISTRY/kubedb/provider-azure:v0.14.0-rc.1
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/provider-gcp:v0.14.0-rc.1 $IMAGE_REGISTRY/kubedb/provider-gcp:v0.14.0-rc.1
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/zookeeper-restic-plugin:v0.9.0-rc.1 $IMAGE_REGISTRY/kubedb/zookeeper-restic-plugin:v0.9.0-rc.1
