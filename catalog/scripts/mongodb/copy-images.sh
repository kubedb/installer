...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mongodb-migrator-cli:v0.5.0-rc.2 $IMAGE_REGISTRY/kubedb/mongodb-migrator-cli:v0.5.0-rc.2
