...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-mongodb-migrator-v0.5.0.tar $IMAGE_REGISTRY/kubedb/kubedb-mongodb-migrator:v0.5.0
