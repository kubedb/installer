...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mongodb-kubedb-migrator-v0.5.0.tar $IMAGE_REGISTRY/kubedb/mongodb-kubedb-migrator:v0.5.0
