...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mongodb-migrator-cli-v0.5.0-rc.2.tar $IMAGE_REGISTRY/kubedb/mongodb-migrator-cli:v0.5.0-rc.2
