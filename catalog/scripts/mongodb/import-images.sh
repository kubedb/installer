...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-migrator-mongodb-v0.7.0-rc.0.tar $IMAGE_REGISTRY/kubedb/kubedb-migrator-mongodb:v0.7.0-rc.0
