...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-migrator-mongodb:v0.7.0-rc.0 images/kubedb-kubedb-migrator-mongodb-v0.7.0-rc.0.tar
