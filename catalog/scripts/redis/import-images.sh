...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-redis-coordinator-v0.36.0-rc.0.tar $IMAGE_REGISTRY/kubedb/redis-coordinator:v0.36.0-rc.0
