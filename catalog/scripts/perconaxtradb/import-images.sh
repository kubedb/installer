...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-percona-xtradb-coordinator-v0.22.0.tar $IMAGE_REGISTRY/kubedb/percona-xtradb-coordinator:v0.22.0
