...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-percona-xtradb-coordinator-v0.33.0-rc.0.tar $IMAGE_REGISTRY/kubedb/percona-xtradb-coordinator:v0.33.0-rc.0
