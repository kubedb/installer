...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-percona-xtradb-coordinator-v0.26.0.tar $IMAGE_REGISTRY/kubedb/percona-xtradb-coordinator:v0.26.0
