...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/percona-xtradb-coordinator:v0.29.0 images/kubedb-percona-xtradb-coordinator-v0.29.0.tar
