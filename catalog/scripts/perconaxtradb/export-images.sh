...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/percona-xtradb-coordinator:v0.26.0-rc.1 images/kubedb-percona-xtradb-coordinator-v0.26.0-rc.1.tar
