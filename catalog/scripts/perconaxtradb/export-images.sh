...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/percona-xtradb-coordinator:v0.33.0-rc.0 images/kubedb-percona-xtradb-coordinator-v0.33.0-rc.0.tar
