...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/percona-xtradb-coordinator:v0.30.0-rc.0 images/kubedb-percona-xtradb-coordinator-v0.30.0-rc.0.tar
