...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/percona-xtradb-coordinator:v0.30.0 $IMAGE_REGISTRY/kubedb/percona-xtradb-coordinator:v0.30.0
