...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/percona-xtradb-coordinator:v0.26.0-rc.1 $IMAGE_REGISTRY/kubedb/percona-xtradb-coordinator:v0.26.0-rc.1
