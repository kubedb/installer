...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/percona-xtradb-coordinator:v0.37.0-rc.0 $IMAGE_REGISTRY/kubedb/percona-xtradb-coordinator:v0.37.0-rc.0
