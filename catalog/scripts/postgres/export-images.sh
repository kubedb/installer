...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/migrator-cli:v0.1.0-rc.0 images/kubedb-migrator-cli-v0.1.0-rc.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/migrator-cli:v0.1.0-rc.1 images/kubedb-migrator-cli-v0.1.0-rc.1.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.22.0-rc.1_12.17-bookworm images/kubedb-postgres-archiver-v0.22.0-rc.1_12.17-bookworm.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.22.0-rc.1_13.13-alpine images/kubedb-postgres-archiver-v0.22.0-rc.1_13.13-alpine.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.22.0-rc.1_13.13-bookworm images/kubedb-postgres-archiver-v0.22.0-rc.1_13.13-bookworm.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.22.0-rc.1_14.10-alpine images/kubedb-postgres-archiver-v0.22.0-rc.1_14.10-alpine.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.22.0-rc.1_14.10-bookworm images/kubedb-postgres-archiver-v0.22.0-rc.1_14.10-bookworm.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.22.0-rc.1_15.5-alpine images/kubedb-postgres-archiver-v0.22.0-rc.1_15.5-alpine.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.22.0-rc.1_15.5-bookworm images/kubedb-postgres-archiver-v0.22.0-rc.1_15.5-bookworm.tar
