...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/appscode-images/percona-distribution-postgresql:17.9 images/appscode-images-percona-distribution-postgresql-17.9.tar
