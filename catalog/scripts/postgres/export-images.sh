...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.22.0-rc.0_12.17-bookworm images/kubedb-postgres-archiver-v0.22.0-rc.0_12.17-bookworm.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.22.0-rc.0_13.13-alpine images/kubedb-postgres-archiver-v0.22.0-rc.0_13.13-alpine.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.22.0-rc.0_13.13-bookworm images/kubedb-postgres-archiver-v0.22.0-rc.0_13.13-bookworm.tar
