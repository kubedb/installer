...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-pg-coordinator-v0.49.0.tar $IMAGE_REGISTRY/kubedb/pg-coordinator:v0.49.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-archiver-v0.26.0_11.22-alpine.tar $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.26.0_11.22-alpine
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-archiver-v0.26.0_11.22-bookworm.tar $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.26.0_11.22-bookworm
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-archiver-v0.26.0_12.17-alpine.tar $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.26.0_12.17-alpine
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-archiver-v0.26.0_12.17-bookworm.tar $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.26.0_12.17-bookworm
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-archiver-v0.26.0_13.13-alpine.tar $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.26.0_13.13-alpine
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-archiver-v0.26.0_13.13-bookworm.tar $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.26.0_13.13-bookworm
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-archiver-v0.26.0_14.10-alpine.tar $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.26.0_14.10-alpine
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgresql-kubedb-migrator-v0.5.0.tar $IMAGE_REGISTRY/kubedb/postgresql-kubedb-migrator:v0.5.0
