...
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-images-postgres-13.22-alpine.tar $IMAGE_REGISTRY/appscode-images/postgres:13.22-alpine
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-images-postgres-13.22-bookworm.tar $IMAGE_REGISTRY/appscode-images/postgres:13.22-bookworm
...
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-images-postgres-14.19-alpine.tar $IMAGE_REGISTRY/appscode-images/postgres:14.19-alpine
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-images-postgres-14.19-bookworm.tar $IMAGE_REGISTRY/appscode-images/postgres:14.19-bookworm
...
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-images-postgres-15.14-alpine.tar $IMAGE_REGISTRY/appscode-images/postgres:15.14-alpine
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-images-postgres-15.14-bookworm.tar $IMAGE_REGISTRY/appscode-images/postgres:15.14-bookworm
...
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-images-postgres-17.6-alpine.tar $IMAGE_REGISTRY/appscode-images/postgres:17.6-alpine
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-images-postgres-17.6-bookworm.tar $IMAGE_REGISTRY/appscode-images/postgres:17.6-bookworm
