...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/pg-coordinator:v0.49.0 $IMAGE_REGISTRY/kubedb/pg-coordinator:v0.49.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.26.0_11.22-alpine $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.26.0_11.22-alpine
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.26.0_11.22-bookworm $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.26.0_11.22-bookworm
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.26.0_12.17-alpine $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.26.0_12.17-alpine
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.26.0_12.17-bookworm $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.26.0_12.17-bookworm
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.26.0_13.13-alpine $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.26.0_13.13-alpine
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.26.0_13.13-bookworm $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.26.0_13.13-bookworm
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.26.0_14.10-alpine $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.26.0_14.10-alpine
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-postgresql-migrator:v0.5.0 $IMAGE_REGISTRY/kubedb/kubedb-postgresql-migrator:v0.5.0
