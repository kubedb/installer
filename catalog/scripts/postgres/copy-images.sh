...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-images/percona-distribution-postgresql:17.9 $IMAGE_REGISTRY/appscode-images/percona-distribution-postgresql:17.9
