...
k3s ctr images import images/kubedb-postgres-archiver-v0.13.0-rc.0_12.17-alpine.tar
k3s ctr images import images/kubedb-postgres-archiver-v0.13.0-rc.0_12.17-bookworm.tar
