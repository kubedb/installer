...
k3s ctr images import images/appscode-images-postgres-13.22-alpine.tar
k3s ctr images import images/appscode-images-postgres-13.22-bookworm.tar
...
k3s ctr images import images/appscode-images-postgres-14.19-alpine.tar
k3s ctr images import images/appscode-images-postgres-14.19-bookworm.tar
...
k3s ctr images import images/appscode-images-postgres-15.14-alpine.tar
k3s ctr images import images/appscode-images-postgres-15.14-bookworm.tar
...
k3s ctr images import images/appscode-images-postgres-17.6-alpine.tar
k3s ctr images import images/appscode-images-postgres-17.6-bookworm.tar
k3s ctr images import images/kubedb-pg-coordinator-v0.41.0.tar
k3s ctr images import images/kubedb-postgres-archiver-v0.18.0_11.22-alpine.tar
k3s ctr images import images/kubedb-postgres-archiver-v0.18.0_11.22-bookworm.tar
k3s ctr images import images/kubedb-postgres-archiver-v0.18.0_12.17-alpine.tar
k3s ctr images import images/kubedb-postgres-archiver-v0.18.0_12.17-bookworm.tar
k3s ctr images import images/kubedb-postgres-archiver-v0.18.0_13.13-alpine.tar
k3s ctr images import images/kubedb-postgres-archiver-v0.18.0_13.13-bookworm.tar
k3s ctr images import images/kubedb-postgres-archiver-v0.18.0_14.10-alpine.tar
k3s ctr images import images/kubedb-postgres-archiver-v0.18.0_14.10-bookworm.tar
k3s ctr images import images/kubedb-postgres-archiver-v0.18.0_15.5-alpine.tar
k3s ctr images import images/kubedb-postgres-archiver-v0.18.0_15.5-bookworm.tar
k3s ctr images import images/kubedb-postgres-archiver-v0.18.0_16.1-alpine.tar
k3s ctr images import images/kubedb-postgres-archiver-v0.18.0_16.1-bookworm.tar
k3s ctr images import images/kubedb-postgres-archiver-v0.18.0_17.2-alpine.tar
k3s ctr images import images/kubedb-postgres-archiver-v0.18.0_17.2-bookworm.tar
