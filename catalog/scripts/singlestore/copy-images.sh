...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/singlestore-coordinator:v0.12.0-rc.0 $IMAGE_REGISTRY/kubedb/singlestore-coordinator:v0.12.0-rc.0
