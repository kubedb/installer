...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/singlestore-coordinator:v0.16.0-rc.1 $IMAGE_REGISTRY/kubedb/singlestore-coordinator:v0.16.0-rc.1
