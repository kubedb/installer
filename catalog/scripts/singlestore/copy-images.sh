...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/singlestore-coordinator:v0.20.0-rc.2 $IMAGE_REGISTRY/kubedb/singlestore-coordinator:v0.20.0-rc.2
