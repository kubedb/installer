...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/singlestore-coordinator:v0.15.0-rc.0 images/kubedb-singlestore-coordinator-v0.15.0-rc.0.tar
