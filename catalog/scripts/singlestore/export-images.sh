...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/singlestore-coordinator:v0.22.0-rc.2 images/kubedb-singlestore-coordinator-v0.22.0-rc.2.tar
