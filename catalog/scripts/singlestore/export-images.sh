...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/singlestore-coordinator:v0.20.0-rc.0 images/kubedb-singlestore-coordinator-v0.20.0-rc.0.tar
