...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-singlestore-coordinator-v0.11.0.tar $IMAGE_REGISTRY/kubedb/singlestore-coordinator:v0.11.0
