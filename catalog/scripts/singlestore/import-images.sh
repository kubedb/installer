...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-singlestore-coordinator-v0.20.0-rc.1.tar $IMAGE_REGISTRY/kubedb/singlestore-coordinator:v0.20.0-rc.1
