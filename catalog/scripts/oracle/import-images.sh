...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-oracle-coordinator-v0.10.0-rc.0.tar $IMAGE_REGISTRY/kubedb/oracle-coordinator:v0.10.0-rc.0
