...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-cruise-control-3.3.0.tar $IMAGE_REGISTRY/kubedb/cruise-control:3.3.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-cruise-control-3.4.0.tar $IMAGE_REGISTRY/kubedb/cruise-control:3.4.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kafka-kraft-3.3.0.tar $IMAGE_REGISTRY/kubedb/kafka-kraft:3.3.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kafka-kraft-3.4.0.tar $IMAGE_REGISTRY/kubedb/kafka-kraft:3.4.0
