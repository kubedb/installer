...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.18.0_5.7.44 images/kubedb-mysql-archiver-v0.18.0_5.7.44.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.18.0_8.0.35 images/kubedb-mysql-archiver-v0.18.0_8.0.35.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.18.0_8.1.0 images/kubedb-mysql-archiver-v0.18.0_8.1.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.18.0_8.2.0 images/kubedb-mysql-archiver-v0.18.0_8.2.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.18.0_8.4.3 images/kubedb-mysql-archiver-v0.18.0_8.4.3.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.18.0_9.1.0 images/kubedb-mysql-archiver-v0.18.0_9.1.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-coordinator:v0.35.0 images/kubedb-mysql-coordinator-v0.35.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-router-init:v0.35.0 images/kubedb-mysql-router-init-v0.35.0.tar
