...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.14.0-rc.1_5.7.44 images/kubedb-mysql-archiver-v0.14.0-rc.1_5.7.44.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.14.0-rc.1_8.0.35 images/kubedb-mysql-archiver-v0.14.0-rc.1_8.0.35.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.14.0-rc.1_8.1.0 images/kubedb-mysql-archiver-v0.14.0-rc.1_8.1.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.14.0-rc.1_8.2.0 images/kubedb-mysql-archiver-v0.14.0-rc.1_8.2.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.14.0-rc.1_8.4.3 images/kubedb-mysql-archiver-v0.14.0-rc.1_8.4.3.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.14.0-rc.1_9.1.0 images/kubedb-mysql-archiver-v0.14.0-rc.1_9.1.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-coordinator:v0.31.0-rc.1 images/kubedb-mysql-coordinator-v0.31.0-rc.1.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-router-init:v0.31.0-rc.1 images/kubedb-mysql-router-init-v0.31.0-rc.1.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/replication-mode-detector:v0.40.0-rc.1 images/kubedb-replication-mode-detector-v0.40.0-rc.1.tar
