...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.21.0-rc.0_5.7.44.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.21.0-rc.0_5.7.44
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.21.0-rc.0_8.0.35.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.21.0-rc.0_8.0.35
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.21.0-rc.0_8.1.0.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.21.0-rc.0_8.1.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.21.0-rc.0_8.2.0.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.21.0-rc.0_8.2.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.21.0-rc.0_8.4.3.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.21.0-rc.0_8.4.3
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.21.0-rc.0_9.1.0.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.21.0-rc.0_9.1.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-coordinator-v0.38.0-rc.0.tar $IMAGE_REGISTRY/kubedb/mysql-coordinator:v0.38.0-rc.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-router-init-v0.38.0-rc.0.tar $IMAGE_REGISTRY/kubedb/mysql-router-init:v0.38.0-rc.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-replication-mode-detector-v0.47.0-rc.0.tar $IMAGE_REGISTRY/kubedb/replication-mode-detector:v0.47.0-rc.0
