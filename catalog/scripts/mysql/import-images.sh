...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.26.0_8.2.0.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.26.0_8.2.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.26.0_8.4.3.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.26.0_8.4.3
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.26.0_9.1.0.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.26.0_9.1.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-kubedb-migrator-v0.5.0.tar $IMAGE_REGISTRY/kubedb/mysql-kubedb-migrator:v0.5.0
