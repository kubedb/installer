...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.10.0_5.7.44.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.10.0_5.7.44
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.10.0_8.0.35.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.10.0_8.0.35
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.10.0_8.1.0.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.10.0_8.1.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.10.0_8.2.0.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.10.0_8.2.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-coordinator-v0.27.0.tar $IMAGE_REGISTRY/kubedb/mysql-coordinator:v0.27.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-init-8.0.31-v3.tar $IMAGE_REGISTRY/kubedb/mysql-init:8.0.31-v3
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-init-8.4.2-v2.tar $IMAGE_REGISTRY/kubedb/mysql-init:8.4.2-v2
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-router-init-v0.27.0.tar $IMAGE_REGISTRY/kubedb/mysql-router-init:v0.27.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-replication-mode-detector-v0.36.0.tar $IMAGE_REGISTRY/kubedb/replication-mode-detector:v0.36.0
