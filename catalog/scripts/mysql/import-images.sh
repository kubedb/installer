...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.21.0-rc.1_8.2.0.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.21.0-rc.1_8.2.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.21.0-rc.1_8.4.3.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.21.0-rc.1_8.4.3
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.21.0-rc.1_9.1.0.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.21.0-rc.1_9.1.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-coordinator-v0.38.0-rc.1.tar $IMAGE_REGISTRY/kubedb/mysql-coordinator:v0.38.0-rc.1
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-router-init-v0.38.0-rc.1.tar $IMAGE_REGISTRY/kubedb/mysql-router-init:v0.38.0-rc.1
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-replication-mode-detector-v0.47.0-rc.1.tar $IMAGE_REGISTRY/kubedb/replication-mode-detector:v0.47.0-rc.1
