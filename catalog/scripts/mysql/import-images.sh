...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.26.0-rc.2_5.7.44.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.26.0-rc.2_5.7.44
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.26.0-rc.2_8.0.35.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.26.0-rc.2_8.0.35
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.26.0-rc.2_8.1.0.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.26.0-rc.2_8.1.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.26.0-rc.2_8.2.0.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.26.0-rc.2_8.2.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.26.0-rc.2_8.4.3.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.26.0-rc.2_8.4.3
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.26.0-rc.2_9.1.0.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.26.0-rc.2_9.1.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-coordinator-v0.43.0-rc.2.tar $IMAGE_REGISTRY/kubedb/mysql-coordinator:v0.43.0-rc.2
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-migrator-cli-v0.5.0-rc.2.tar $IMAGE_REGISTRY/kubedb/mysql-migrator-cli:v0.5.0-rc.2
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-router-init-v0.43.0-rc.2.tar $IMAGE_REGISTRY/kubedb/mysql-router-init:v0.43.0-rc.2
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-replication-mode-detector-v0.52.0-rc.2.tar $IMAGE_REGISTRY/kubedb/replication-mode-detector:v0.52.0-rc.2
