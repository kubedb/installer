...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.13.0-rc.0_5.7.44.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.13.0-rc.0_5.7.44
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.13.0-rc.0_8.0.35.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.13.0-rc.0_8.0.35
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.13.0-rc.0_8.1.0.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.13.0-rc.0_8.1.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.13.0-rc.0_8.2.0.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.13.0-rc.0_8.2.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.13.0-rc.0_8.4.3.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.13.0-rc.0_8.4.3
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-archiver-v0.13.0-rc.0_9.1.0.tar $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.13.0-rc.0_9.1.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mysql-coordinator-v0.30.0-rc.0.tar $IMAGE_REGISTRY/kubedb/mysql-coordinator:v0.30.0-rc.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-replication-mode-detector-v0.39.0-rc.0.tar $IMAGE_REGISTRY/kubedb/replication-mode-detector:v0.39.0-rc.0
