...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-migrator-mysql:v0.7.0-rc.0 $IMAGE_REGISTRY/kubedb/kubedb-migrator-mysql:v0.7.0-rc.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.28.0-rc.0_5.7.44 $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.28.0-rc.0_5.7.44
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.28.0-rc.0_8.0.35 $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.28.0-rc.0_8.0.35
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.28.0-rc.0_8.1.0 $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.28.0-rc.0_8.1.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.28.0-rc.0_8.2.0 $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.28.0-rc.0_8.2.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.28.0-rc.0_8.4.3 $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.28.0-rc.0_8.4.3
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.28.0-rc.0_9.1.0 $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.28.0-rc.0_9.1.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-coordinator:v0.45.0-rc.0 $IMAGE_REGISTRY/kubedb/mysql-coordinator:v0.45.0-rc.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-router-init:v0.45.0-rc.0 $IMAGE_REGISTRY/kubedb/mysql-router-init:v0.45.0-rc.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/replication-mode-detector:v0.54.0-rc.0 $IMAGE_REGISTRY/kubedb/replication-mode-detector:v0.54.0-rc.0
