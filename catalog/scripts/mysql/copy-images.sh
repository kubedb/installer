...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.24.0_5.7.44 $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.24.0_5.7.44
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.24.0_8.0.35 $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.24.0_8.0.35
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.26.0-rc.0_5.7.44 $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.26.0-rc.0_5.7.44
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.26.0-rc.0_8.0.35 $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.26.0-rc.0_8.0.35
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.26.0-rc.0_8.1.0 $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.26.0-rc.0_8.1.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.26.0-rc.0_8.2.0 $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.26.0-rc.0_8.2.0
