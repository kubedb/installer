...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.22.0-rc.1_5.7.44 $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.22.0-rc.1_5.7.44
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.22.0-rc.1_8.0.35 $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.22.0-rc.1_8.0.35
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.22.0-rc.1_8.1.0 $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.22.0-rc.1_8.1.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.22.0-rc.1_8.2.0 $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.22.0-rc.1_8.2.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.22.0-rc.1_8.4.3 $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.22.0-rc.1_8.4.3
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.22.0-rc.1_9.1.0 $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.22.0-rc.1_9.1.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-coordinator:v0.39.0-rc.1 $IMAGE_REGISTRY/kubedb/mysql-coordinator:v0.39.0-rc.1
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-init:8.4.3-v5 $IMAGE_REGISTRY/kubedb/mysql-init:8.4.3-v5
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-init:9.1.0-v3 $IMAGE_REGISTRY/kubedb/mysql-init:9.1.0-v3
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-router-init:v0.39.0-rc.1 $IMAGE_REGISTRY/kubedb/mysql-router-init:v0.39.0-rc.1
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/replication-mode-detector:v0.48.0-rc.1 $IMAGE_REGISTRY/kubedb/replication-mode-detector:v0.48.0-rc.1
