...
k3s ctr images import images/kubedb-kubedb-migrator-mysql-v0.7.0-rc.2.tar
k3s ctr images import images/kubedb-mysql-archiver-v0.28.0-rc.2_5.7.44.tar
k3s ctr images import images/kubedb-mysql-archiver-v0.28.0-rc.2_8.0.35.tar
k3s ctr images import images/kubedb-mysql-archiver-v0.28.0-rc.2_8.1.0.tar
k3s ctr images import images/kubedb-mysql-archiver-v0.28.0-rc.2_8.2.0.tar
k3s ctr images import images/kubedb-mysql-archiver-v0.28.0-rc.2_8.4.3.tar
k3s ctr images import images/kubedb-mysql-archiver-v0.28.0-rc.2_9.1.0.tar
k3s ctr images import images/kubedb-mysql-coordinator-v0.45.0-rc.2.tar
k3s ctr images import images/kubedb-mysql-init-0.2.0.tar
k3s ctr images import images/kubedb-mysql-init-5.7-v9.tar
k3s ctr images import images/kubedb-mysql-router-init-v0.45.0-rc.2.tar
k3s ctr images import images/kubedb-mysqld-exporter-v0.18.0.tar
k3s ctr images import images/kubedb-replication-mode-detector-v0.54.0-rc.2.tar
