...
k3s ctr images import images/kubedb-mysql-archiver-v0.18.0_5.7.44.tar
k3s ctr images import images/kubedb-mysql-archiver-v0.18.0_8.0.35.tar
k3s ctr images import images/kubedb-mysql-archiver-v0.18.0_8.1.0.tar
k3s ctr images import images/kubedb-mysql-archiver-v0.18.0_8.2.0.tar
k3s ctr images import images/kubedb-mysql-archiver-v0.18.0_8.4.3.tar
k3s ctr images import images/kubedb-mysql-archiver-v0.18.0_9.1.0.tar
k3s ctr images import images/kubedb-mysql-coordinator-v0.35.0.tar
...
k3s ctr images import images/kubedb-mysql-router-init-v0.35.0.tar
k3s ctr images import images/kubedb-mysqld-exporter-v0.13.1.tar
k3s ctr images import images/kubedb-replication-mode-detector-v0.44.0.tar
