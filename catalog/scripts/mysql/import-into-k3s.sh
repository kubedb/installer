...
k3s ctr images import images/kubedb-mysql-archiver-v0.21.0-rc.1_8.2.0.tar
k3s ctr images import images/kubedb-mysql-archiver-v0.21.0-rc.1_8.4.3.tar
k3s ctr images import images/kubedb-mysql-archiver-v0.21.0-rc.1_9.1.0.tar
k3s ctr images import images/kubedb-mysql-coordinator-v0.38.0-rc.1.tar
