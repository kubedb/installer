...
k3s ctr images import images/kubedb-mysql-archiver-v0.10.0_5.7.44.tar
k3s ctr images import images/kubedb-mysql-archiver-v0.10.0_8.0.35.tar
k3s ctr images import images/kubedb-mysql-archiver-v0.10.0_8.1.0.tar
k3s ctr images import images/kubedb-mysql-archiver-v0.10.0_8.2.0.tar
k3s ctr images import images/kubedb-mysql-coordinator-v0.27.0.tar
k3s ctr images import images/kubedb-mysql-init-5.7-v4.tar
k3s ctr images import images/kubedb-mysql-init-8.0.31-v3.tar
k3s ctr images import images/kubedb-mysql-init-8.4.2-v2.tar
k3s ctr images import images/kubedb-mysql-router-init-v0.27.0.tar
k3s ctr images import images/kubedb-mysqld-exporter-v0.13.1.tar
k3s ctr images import images/kubedb-replication-mode-detector-v0.36.0.tar
