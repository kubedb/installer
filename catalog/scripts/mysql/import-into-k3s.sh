...
k3s ctr images import images/kubedb-mysql-archiver-v0.21.0_8.0.35.tar
k3s ctr images import images/kubedb-mysql-archiver-v0.21.0_8.1.0.tar
k3s ctr images import images/kubedb-mysql-archiver-v0.21.0_8.2.0.tar
k3s ctr images import images/kubedb-mysql-archiver-v0.21.0_8.4.3.tar
k3s ctr images import images/kubedb-mysql-archiver-v0.21.0_9.1.0.tar
k3s ctr images import images/kubedb-mysql-coordinator-v0.38.0.tar
...
k3s ctr images import images/kubedb-mysql-router-init-v0.38.0.tar
k3s ctr images import images/kubedb-mysqld-exporter-v0.18.0.tar
k3s ctr images import images/kubedb-replication-mode-detector-v0.47.0.tar
