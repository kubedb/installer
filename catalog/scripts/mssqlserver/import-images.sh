...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mssqlserver-archiver-v0.19.0-rc.1.tar $IMAGE_REGISTRY/kubedb/mssqlserver-archiver:v0.19.0-rc.1
