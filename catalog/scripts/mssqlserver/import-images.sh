...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mssql-coordinator-v0.20.0-rc.2.tar $IMAGE_REGISTRY/kubedb/mssql-coordinator:v0.20.0-rc.2
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mssqlserver-archiver-v0.19.0-rc.2.tar $IMAGE_REGISTRY/kubedb/mssqlserver-archiver:v0.19.0-rc.2
