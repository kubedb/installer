...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mssql-coordinator-v0.19.0-rc.0.tar $IMAGE_REGISTRY/kubedb/mssql-coordinator:v0.19.0-rc.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-mssqlserver-archiver-v0.18.0-rc.0.tar $IMAGE_REGISTRY/kubedb/mssqlserver-archiver:v0.18.0-rc.0
