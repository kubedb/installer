...
k3s ctr images import images/kubedb-kubedb-migrator-mssqlserver-v0.7.0-rc.0.tar
k3s ctr images import images/kubedb-mssql-coordinator-v0.22.0-rc.0.tar
...
k3s ctr images import images/kubedb-mssqlserver-archiver-v0.21.0-rc.0.tar
