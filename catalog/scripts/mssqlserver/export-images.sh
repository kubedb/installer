...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssqlserver-archiver:v0.14.0-rc.1 images/kubedb-mssqlserver-archiver-v0.14.0-rc.1.tar
