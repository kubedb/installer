...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssql-coordinator:v0.11.0 images/kubedb-mssql-coordinator-v0.11.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssqlserver-archiver:v0.10.0 images/kubedb-mssqlserver-archiver-v0.10.0.tar
