...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssql-coordinator:v0.13.0 images/kubedb-mssql-coordinator-v0.13.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssqlserver-archiver:v0.12.0 images/kubedb-mssqlserver-archiver-v0.12.0.tar
