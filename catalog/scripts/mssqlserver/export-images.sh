...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-migrator-mssqlserver:v0.7.0-rc.0 images/kubedb-kubedb-migrator-mssqlserver-v0.7.0-rc.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssql-coordinator:v0.22.0-rc.0 images/kubedb-mssql-coordinator-v0.22.0-rc.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssqlserver-archiver:v0.21.0-rc.0 images/kubedb-mssqlserver-archiver-v0.21.0-rc.0.tar
