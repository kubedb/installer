...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssql-coordinator:v0.16.0-rc.1 images/kubedb-mssql-coordinator-v0.16.0-rc.1.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssqlserver-archiver:v0.15.0-rc.1 images/kubedb-mssqlserver-archiver-v0.15.0-rc.1.tar
