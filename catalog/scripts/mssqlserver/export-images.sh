...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssql-coordinator:v0.19.0-rc.0 images/kubedb-mssql-coordinator-v0.19.0-rc.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssqlserver-archiver:v0.18.0-rc.0 images/kubedb-mssqlserver-archiver-v0.18.0-rc.0.tar
