...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssql-coordinator:v0.6.0 $IMAGE_REGISTRY/kubedb/mssql-coordinator:v0.6.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssqlserver-archiver:v0.5.0 $IMAGE_REGISTRY/kubedb/mssqlserver-archiver:v0.5.0
