...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-migrator-mssqlserver:v0.7.0-rc.2 $IMAGE_REGISTRY/kubedb/kubedb-migrator-mssqlserver:v0.7.0-rc.2
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssql-coordinator:v0.22.0-rc.2 $IMAGE_REGISTRY/kubedb/mssql-coordinator:v0.22.0-rc.2
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssqlserver-archiver:v0.21.0-rc.2 $IMAGE_REGISTRY/kubedb/mssqlserver-archiver:v0.21.0-rc.2
