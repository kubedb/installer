...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssql-coordinator:v0.14.0 $IMAGE_REGISTRY/kubedb/mssql-coordinator:v0.14.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssqlserver-archiver:v0.13.0 $IMAGE_REGISTRY/kubedb/mssqlserver-archiver:v0.13.0
