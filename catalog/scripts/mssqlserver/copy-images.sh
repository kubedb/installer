...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssql-coordinator:v0.8.0-rc.1 $IMAGE_REGISTRY/kubedb/mssql-coordinator:v0.8.0-rc.1
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssqlserver-archiver:v0.7.0-rc.1 $IMAGE_REGISTRY/kubedb/mssqlserver-archiver:v0.7.0-rc.1
