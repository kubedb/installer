...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssql-coordinator:v0.20.0-rc.2 $IMAGE_REGISTRY/kubedb/mssql-coordinator:v0.20.0-rc.2
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssqlserver-archiver:v0.19.0-rc.2 $IMAGE_REGISTRY/kubedb/mssqlserver-archiver:v0.19.0-rc.2
