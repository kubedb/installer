...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/db2-coordinator:v0.1.0-rc.1 $IMAGE_REGISTRY/kubedb/db2-coordinator:v0.1.0-rc.1
...
$CMD cp --allow-nondistributable-artifacts --insecure qdrant/qdrant:v1.16.2 $IMAGE_REGISTRY/qdrant/qdrant:v1.16.2
