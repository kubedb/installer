...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/db2-coordinator:v0.5.0 $IMAGE_REGISTRY/kubedb/db2-coordinator:v0.5.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/hanadb-coordinator:v0.4.0 $IMAGE_REGISTRY/kubedb/hanadb-coordinator:v0.4.0
