...
$CMD cp --allow-nondistributable-artifacts --insecure apache/druid:25.0.0 $IMAGE_REGISTRY/apache/druid:25.0.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/dashboard-restic-plugin:v0.6.0 $IMAGE_REGISTRY/kubedb/dashboard-restic-plugin:v0.6.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/elasticsearch-restic-plugin:v0.11.0 $IMAGE_REGISTRY/kubedb/elasticsearch-restic-plugin:v0.11.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-kibana:v0.24.0 $IMAGE_REGISTRY/kubedb/kubedb-kibana:v0.24.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-manifest-plugin:v0.11.0 $IMAGE_REGISTRY/kubedb/kubedb-manifest-plugin:v0.11.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-ui-server:v0.24.1 $IMAGE_REGISTRY/kubedb/kubedb-ui-server:v0.24.1
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.4.0_10.10.7-jammy $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.4.0_10.10.7-jammy
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.4.0_10.11.6-jammy $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.4.0_10.11.6-jammy
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.4.0_10.4.32-focal $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.4.0_10.4.32-focal
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.4.0_10.5.23-focal $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.4.0_10.5.23-focal
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.4.0_10.6.16-focal $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.4.0_10.6.16-focal
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.4.0_11.0.4-jammy $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.4.0_11.0.4-jammy
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.4.0_11.1.3-jammy $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.4.0_11.1.3-jammy
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.4.0_11.2.2-jammy $IMAGE_REGISTRY/kubedb/mariadb-archiver:v0.4.0_11.2.2-jammy
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-coordinator:v0.28.0 $IMAGE_REGISTRY/kubedb/mariadb-coordinator:v0.28.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-csi-snapshotter-plugin:v0.8.0 $IMAGE_REGISTRY/kubedb/mariadb-csi-snapshotter-plugin:v0.8.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-restic-plugin:v0.6.0 $IMAGE_REGISTRY/kubedb/mariadb-restic-plugin:v0.6.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mongodb-csi-snapshotter-plugin:v0.9.0 $IMAGE_REGISTRY/kubedb/mongodb-csi-snapshotter-plugin:v0.9.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssql-coordinator:v0.3.0 $IMAGE_REGISTRY/kubedb/mssql-coordinator:v0.3.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssqlserver-archiver:v0.0.1 $IMAGE_REGISTRY/kubedb/mssqlserver-archiver:v0.0.1
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.9.0_5.7.44 $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.9.0_5.7.44
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.9.0_8.0.35 $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.9.0_8.0.35
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.9.0_8.1.0 $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.9.0_8.1.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.9.0_8.2.0 $IMAGE_REGISTRY/kubedb/mysql-archiver:v0.9.0_8.2.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-coordinator:v0.26.0 $IMAGE_REGISTRY/kubedb/mysql-coordinator:v0.26.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-csi-snapshotter-plugin:v0.9.0 $IMAGE_REGISTRY/kubedb/mysql-csi-snapshotter-plugin:v0.9.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-router-init:v0.26.0 $IMAGE_REGISTRY/kubedb/mysql-router-init:v0.26.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/percona-xtradb-coordinator:v0.21.0 $IMAGE_REGISTRY/kubedb/percona-xtradb-coordinator:v0.21.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.9.0_11.22-alpine $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.9.0_11.22-alpine
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.9.0_11.22-bookworm $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.9.0_11.22-bookworm
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.9.0_12.17-alpine $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.9.0_12.17-alpine
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.9.0_12.17-bookworm $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.9.0_12.17-bookworm
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.9.0_13.13-alpine $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.9.0_13.13-alpine
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.9.0_13.13-bookworm $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.9.0_13.13-bookworm
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.9.0_14.10-alpine $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.9.0_14.10-alpine
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.9.0_14.10-bookworm $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.9.0_14.10-bookworm
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.9.0_15.5-bookworm $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.9.0_15.5-bookworm
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/provider-gcp:v0.10.0 $IMAGE_REGISTRY/kubedb/provider-gcp:v0.10.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/replication-mode-detector:v0.35.0 $IMAGE_REGISTRY/kubedb/replication-mode-detector:v0.35.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/singlestore-coordinator:v0.3.0 $IMAGE_REGISTRY/kubedb/singlestore-coordinator:v0.3.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/zookeeper-restic-plugin:v0.4.0 $IMAGE_REGISTRY/kubedb/zookeeper-restic-plugin:v0.4.0
