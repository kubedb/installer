...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/db2-coordinator:v0.2.0-rc.1 $IMAGE_REGISTRY/kubedb/db2-coordinator:v0.2.0-rc.1
...
$CMD cp --allow-nondistributable-artifacts --insecure ibmcom/db2:11.5.8.0 $IMAGE_REGISTRY/ibmcom/db2:11.5.8.0
