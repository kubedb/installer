...
$CMD pull --allow-nondistributable-artifacts --insecure apache/druid:25.0.0 images/apache-druid-25.0.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/dashboard-restic-plugin:v0.6.0 images/kubedb-dashboard-restic-plugin-v0.6.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/elasticsearch-restic-plugin:v0.11.0 images/kubedb-elasticsearch-restic-plugin-v0.11.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-ui-server:v0.24.1 images/kubedb-kubedb-ui-server-v0.24.1.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.4.0_10.10.7-jammy images/kubedb-mariadb-archiver-v0.4.0_10.10.7-jammy.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.4.0_10.11.6-jammy images/kubedb-mariadb-archiver-v0.4.0_10.11.6-jammy.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.4.0_10.4.32-focal images/kubedb-mariadb-archiver-v0.4.0_10.4.32-focal.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.4.0_10.5.23-focal images/kubedb-mariadb-archiver-v0.4.0_10.5.23-focal.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.4.0_10.6.16-focal images/kubedb-mariadb-archiver-v0.4.0_10.6.16-focal.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.4.0_11.0.4-jammy images/kubedb-mariadb-archiver-v0.4.0_11.0.4-jammy.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.4.0_11.1.3-jammy images/kubedb-mariadb-archiver-v0.4.0_11.1.3-jammy.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-archiver:v0.4.0_11.2.2-jammy images/kubedb-mariadb-archiver-v0.4.0_11.2.2-jammy.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-coordinator:v0.28.0 images/kubedb-mariadb-coordinator-v0.28.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-csi-snapshotter-plugin:v0.8.0 images/kubedb-mariadb-csi-snapshotter-plugin-v0.8.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mariadb-restic-plugin:v0.6.0 images/kubedb-mariadb-restic-plugin-v0.6.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mongodb-csi-snapshotter-plugin:v0.9.0 images/kubedb-mongodb-csi-snapshotter-plugin-v0.9.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssql-coordinator:v0.3.0 images/kubedb-mssql-coordinator-v0.3.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mssqlserver-archiver:v0.0.1 images/kubedb-mssqlserver-archiver-v0.0.1.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.9.0_5.7.44 images/kubedb-mysql-archiver-v0.9.0_5.7.44.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.9.0_8.0.35 images/kubedb-mysql-archiver-v0.9.0_8.0.35.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.9.0_8.1.0 images/kubedb-mysql-archiver-v0.9.0_8.1.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-archiver:v0.9.0_8.2.0 images/kubedb-mysql-archiver-v0.9.0_8.2.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-coordinator:v0.26.0 images/kubedb-mysql-coordinator-v0.26.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-csi-snapshotter-plugin:v0.9.0 images/kubedb-mysql-csi-snapshotter-plugin-v0.9.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/mysql-router-init:v0.26.0 images/kubedb-mysql-router-init-v0.26.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/percona-xtradb-coordinator:v0.21.0 images/kubedb-percona-xtradb-coordinator-v0.21.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.9.0_11.22-alpine images/kubedb-postgres-archiver-v0.9.0_11.22-alpine.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.9.0_11.22-bookworm images/kubedb-postgres-archiver-v0.9.0_11.22-bookworm.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.9.0_12.17-alpine images/kubedb-postgres-archiver-v0.9.0_12.17-alpine.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.9.0_12.17-bookworm images/kubedb-postgres-archiver-v0.9.0_12.17-bookworm.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.9.0_13.13-alpine images/kubedb-postgres-archiver-v0.9.0_13.13-alpine.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.9.0_13.13-bookworm images/kubedb-postgres-archiver-v0.9.0_13.13-bookworm.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.9.0_14.10-alpine images/kubedb-postgres-archiver-v0.9.0_14.10-alpine.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.9.0_14.10-bookworm images/kubedb-postgres-archiver-v0.9.0_14.10-bookworm.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.9.0_15.5-bookworm images/kubedb-postgres-archiver-v0.9.0_15.5-bookworm.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/provider-gcp:v0.10.0 images/kubedb-provider-gcp-v0.10.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/replication-mode-detector:v0.35.0 images/kubedb-replication-mode-detector-v0.35.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/singlestore-coordinator:v0.3.0 images/kubedb-singlestore-coordinator-v0.3.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/zookeeper-restic-plugin:v0.4.0 images/kubedb-zookeeper-restic-plugin-v0.4.0.tar
