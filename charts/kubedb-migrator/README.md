...
$ helm repo update
$ helm search repo appscode/kubedb-migrator --version=v0.5.0-rc.0
$ helm upgrade -i kubedb-migrator appscode/kubedb-migrator -n kubedb --create-namespace --version=v0.5.0-rc.0
```
...
```bash
$ helm upgrade -i kubedb-migrator appscode/kubedb-migrator -n kubedb --create-namespace --version=v0.5.0-rc.0 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-migrator appscode/kubedb-migrator -n kubedb --create-namespace --version=v0.5.0-rc.0 --values values.yaml
```
