...
$ helm repo update
$ helm search repo appscode/kubedb-migrator --version=v0.5.0-rc.2
$ helm upgrade -i kubedb-migrator appscode/kubedb-migrator -n kubedb --create-namespace --version=v0.5.0-rc.2
```
...
```bash
$ helm upgrade -i kubedb-migrator appscode/kubedb-migrator -n kubedb --create-namespace --version=v0.5.0-rc.2 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-migrator appscode/kubedb-migrator -n kubedb --create-namespace --version=v0.5.0-rc.2 --values values.yaml
```
