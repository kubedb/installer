...
$ helm repo update
$ helm search repo appscode/kubedb-one --version=v2023.04.10
$ helm upgrade -i kubedb appscode/kubedb-one -n kubedb --create-namespace --version=v2023.04.10
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb-one -n kubedb --create-namespace --version=v2023.04.10 --set global.registry=kubedb
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb-one -n kubedb --create-namespace --version=v2023.04.10 --values values.yaml
```
