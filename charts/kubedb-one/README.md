...
$ helm repo update
$ helm search repo appscode/kubedb-one --version=v2023.12.11
$ helm upgrade -i kubedb appscode/kubedb-one -n kubedb --create-namespace --version=v2023.12.11
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb-one -n kubedb --create-namespace --version=v2023.12.11 --set global.registry=kubedb
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb-one -n kubedb --create-namespace --version=v2023.12.11 --values values.yaml
```
