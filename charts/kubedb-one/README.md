...
$ helm repo update
$ helm search repo appscode/kubedb-one --version=v2023.01.31
$ helm upgrade -i kubedb appscode/kubedb-one -n kubedb --create-namespace --version=v2023.01.31
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb-one -n kubedb --create-namespace --version=v2023.01.31 --set global.registry=kubedb
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb-one -n kubedb --create-namespace --version=v2023.01.31 --values values.yaml
```
