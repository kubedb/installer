...
$ helm repo update
$ helm search repo appscode/kubedb-one --version=v2023.02.28
$ helm upgrade -i kubedb appscode/kubedb-one -n kubedb --create-namespace --version=v2023.02.28
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb-one -n kubedb --create-namespace --version=v2023.02.28 --set global.registry=kubedb
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb-one -n kubedb --create-namespace --version=v2023.02.28 --values values.yaml
```
