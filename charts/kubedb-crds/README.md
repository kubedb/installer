...
$ helm repo update
$ helm search repo appscode/kubedb-crds --version=v2023.06.19
$ helm upgrade -i kubedb-crds appscode/kubedb-crds -n kubedb --create-namespace --version=v2023.06.19
```
