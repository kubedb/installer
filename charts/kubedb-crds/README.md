...
$ helm repo update
$ helm search repo appscode/kubedb-crds --version=v2026.8.26-rc.2
$ helm upgrade -i kubedb-crds appscode/kubedb-crds -n kubedb --create-namespace --version=v2026.8.26-rc.2
```
