...
$ helm repo update
$ helm search repo appscode/kubedb-crds --version=v2025.7.30-rc.0
$ helm upgrade -i kubedb-crds appscode/kubedb-crds -n kubedb --create-namespace --version=v2025.7.30-rc.0
```
