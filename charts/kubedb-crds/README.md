...
$ helm repo update
$ helm search repo appscode/kubedb-crds --version=v2024.11.18
$ helm upgrade -i kubedb-crds appscode/kubedb-crds -n kubedb --create-namespace --version=v2024.11.18
```
