...
$ helm repo update
$ helm search repo appscode/kubedb-crds --version=v2026.6.18-rc.2
$ helm upgrade -i kubedb-crds appscode/kubedb-crds -n kubedb --create-namespace --version=v2026.6.18-rc.2
```
