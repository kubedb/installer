...
$ helm repo update
$ helm search repo appscode/kubedb-crds --version=v2026.8.14-rc.0
$ helm upgrade -i kubedb-crds appscode/kubedb-crds -n kubedb --create-namespace --version=v2026.8.14-rc.0
```
