...
$ helm repo update
$ helm search repo appscode/kubedb-crds --version=v2025.3.20-rc.1
$ helm upgrade -i kubedb-crds appscode/kubedb-crds -n kubedb --create-namespace --version=v2025.3.20-rc.1
```
