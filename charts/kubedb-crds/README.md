...
$ helm repo update
$ helm search repo appscode/kubedb-crds --version=v2024.8.14-rc.3
$ helm upgrade -i kubedb-crds appscode/kubedb-crds -n kubedb --create-namespace --version=v2024.8.14-rc.3
```
