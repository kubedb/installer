...
$ helm repo update
$ helm search repo appscode/kubedb-crds --version=v2022.10.12-rc.0
$ helm upgrade -i kubedb-crds appscode/kubedb-crds -n kubedb --create-namespace --version=v2022.10.12-rc.0
```
