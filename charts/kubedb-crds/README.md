...
$ helm repo update
$ helm search repo appscode/kubedb-crds --version=v2022.12.24-rc.1
$ helm upgrade -i kubedb-crds appscode/kubedb-crds -n kubedb --create-namespace --version=v2022.12.24-rc.1
```
