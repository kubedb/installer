...
$ helm repo update
$ helm search repo appscode/kubedb-gitops --version=v0.7.0
$ helm upgrade -i kubedb-gitops appscode/kubedb-gitops -n kubedb --create-namespace --version=v0.7.0
```
...
```bash
$ helm upgrade -i kubedb-gitops appscode/kubedb-gitops -n kubedb --create-namespace --version=v0.7.0 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-gitops appscode/kubedb-gitops -n kubedb --create-namespace --version=v0.7.0 --values values.yaml
```
