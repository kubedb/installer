...
$ helm repo update
$ helm search repo appscode/kubedb-kubestash-catalog --version=v2023.12.28
$ helm upgrade -i kubedb-kubestash-catalog appscode/kubedb-kubestash-catalog -n stash --create-namespace --version=v2023.12.28
```
...
```bash
$ helm upgrade -i kubedb-kubestash-catalog appscode/kubedb-kubestash-catalog -n stash --create-namespace --version=v2023.12.28 --set proxies.ghcr=ghcr.io
```
...
```bash
$ helm upgrade -i kubedb-kubestash-catalog appscode/kubedb-kubestash-catalog -n stash --create-namespace --version=v2023.12.28 --values values.yaml
```
