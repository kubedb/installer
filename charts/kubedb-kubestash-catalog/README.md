...
$ helm repo update
$ helm search repo appscode/kubedb-kubestash-catalog --version=v2024.3.9-rc.0
$ helm upgrade -i kubedb-kubestash-catalog appscode/kubedb-kubestash-catalog -n stash --create-namespace --version=v2024.3.9-rc.0
```
...
```bash
$ helm upgrade -i kubedb-kubestash-catalog appscode/kubedb-kubestash-catalog -n stash --create-namespace --version=v2024.3.9-rc.0 --set proxies.ghcr=ghcr.io
```
...
```bash
$ helm upgrade -i kubedb-kubestash-catalog appscode/kubedb-kubestash-catalog -n stash --create-namespace --version=v2024.3.9-rc.0 --values values.yaml
```
