...
$ helm repo update
$ helm search repo appscode/kubedb-ui-server --version=v0.8.0
$ helm upgrade -i kubedb-ui-server appscode/kubedb-ui-server -n kubeops --create-namespace --version=v0.8.0
```
...
```bash
$ helm upgrade -i kubedb-ui-server appscode/kubedb-ui-server -n kubeops --create-namespace --version=v0.8.0 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-ui-server appscode/kubedb-ui-server -n kubeops --create-namespace --version=v0.8.0 --values values.yaml
```
