...
$ helm repo update
$ helm search repo appscode/kubedb-ui-server --version=v0.6.0-rc.0
$ helm upgrade -i kubedb-ui-server appscode/kubedb-ui-server -n kubeops --create-namespace --version=v0.6.0-rc.0
```
...
```bash
$ helm upgrade -i kubedb-ui-server appscode/kubedb-ui-server -n kubeops --create-namespace --version=v0.6.0-rc.0 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-ui-server appscode/kubedb-ui-server -n kubeops --create-namespace --version=v0.6.0-rc.0 --values values.yaml
```
