...
$ helm repo update
$ helm search repo appscode/kubedb-grafana-dashboards --version=v2022.10.12-rc.0
$ helm upgrade -i kubedb-grafana-dashboards appscode/kubedb-grafana-dashboards -n kubeops --create-namespace --version=v2022.10.12-rc.0
```
...
```bash
$ helm upgrade -i kubedb-grafana-dashboards appscode/kubedb-grafana-dashboards -n kubeops --create-namespace --version=v2022.10.12-rc.0 --set resources=["elasticsearch","mariadb","mongodb","mysql","postgres","redis"]
```
...
```bash
$ helm upgrade -i kubedb-grafana-dashboards appscode/kubedb-grafana-dashboards -n kubeops --create-namespace --version=v2022.10.12-rc.0 --values values.yaml
```
