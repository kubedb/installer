...
```bash
$ helm upgrade -i kubedb-grafana-dashboards appscode/kubedb-grafana-dashboards -n kubeops --create-namespace --version=v2024.11.8-rc.0 --set resources=["elasticsearch","mariadb","mongodb","mysql","postgres","redis"]
```
