...
$ helm repo update
$ helm search repo appscode/kubedb-grafana-dashboards --version=v2025.4.30
$ helm upgrade -i kubedb-grafana-dashboards appscode/kubedb-grafana-dashboards -n kubeops --create-namespace --version=v2025.4.30
```
...
| resources                       | List of resources for which dashboards will be applied                                                                                                                                                                             | <code>["ignite"]</code>                                                                                                                                                                        |
...
| grafana.name                    | Name of Grafana Appbinding where these dashboards are applied                                                                                                                                                                      | <code>"prometheus-grafana"</code>                                                                                                                                                              |
| grafana.namespace               | Namespace of Grafana Appbinding where these dashboards are applied                                                                                                                                                                 | <code>"monitoring"</code>                                                                                                                                                                      |
| grafana.version                 |                                                                                                                                                                                                                                    | <code>8.0.7</code>                                                                                                                                                                             |
| grafana.url                     |                                                                                                                                                                                                                                    | <code>"http://prometheus-grafana.monitoring.svc:80"</code>                                                                                                                                     |
| grafana.apikey                  |                                                                                                                                                                                                                                    | <code>""</code>                                                                                                                                                                                |
| app.name                        |                                                                                                                                                                                                                                    | <code>"ignite-quickstart"</code>                                                                                                                                                               |
...
```bash
$ helm upgrade -i kubedb-grafana-dashboards appscode/kubedb-grafana-dashboards -n kubeops --create-namespace --version=v2025.4.30 --set resources=["ignite"]
```
...
```bash
$ helm upgrade -i kubedb-grafana-dashboards appscode/kubedb-grafana-dashboards -n kubeops --create-namespace --version=v2025.4.30 --values values.yaml
```
