...
$ helm repo update
$ helm search repo appscode/kubedb-grafana-dashboards --version=v2022.10.18
$ helm upgrade -i kubedb-grafana-dashboards appscode/kubedb-grafana-dashboards -n kubeops --create-namespace --version=v2022.10.18
```
...
```bash
$ helm upgrade -i kubedb-grafana-dashboards appscode/kubedb-grafana-dashboards -n kubeops --create-namespace --version=v2022.10.18 --values values.yaml
```
