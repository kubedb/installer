...
$ helm repo update
$ helm search repo appscode/kubedb-crd-manager --version=v0.7.0-rc.0
$ helm upgrade -i kubedb-ops-manager appscode/kubedb-crd-manager -n kubedb --create-namespace --version=v0.7.0-rc.0
```
...
```bash
$ helm upgrade -i kubedb-ops-manager appscode/kubedb-crd-manager -n kubedb --create-namespace --version=v0.7.0-rc.0 --set registryFQDN=ghcr.io
```
...
```bash
$ helm upgrade -i kubedb-ops-manager appscode/kubedb-crd-manager -n kubedb --create-namespace --version=v0.7.0-rc.0 --values values.yaml
```
