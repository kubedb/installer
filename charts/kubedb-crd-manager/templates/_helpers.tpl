...
*/}}
{{- define "kubedb-crd-manager.name" -}}
...
*/}}
{{- define "kubedb-crd-manager.fullname" -}}
...
*/}}
{{- define "kubedb-crd-manager.chart" -}}
...
Selector labels
*/}}
{{- define "kubedb-crd-manager.selectorLabels" -}}
app.kubernetes.io/name: {{ include "kubedb-crd-manager.name" . }}
...
*/}}
{{- define "kubedb-crd-manager.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "kubedb-crd-manager.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
{{- printf "%s-license" (include "kubedb-crd-manager.fullname" .) -}}
{{- end }}
{{- end }}
