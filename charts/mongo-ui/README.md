...
$ helm repo update
$ helm search repo appscode/mongo-ui --version=v0.1.0
$ helm upgrade -i mongo-ui appscode/mongo-ui -n demo --create-namespace --version=v0.1.0
```
...
```bash
$ helm upgrade -i mongo-ui appscode/mongo-ui -n demo --create-namespace --version=v0.1.0 --set image.tag=latest
```
...
```bash
$ helm upgrade -i mongo-ui appscode/mongo-ui -n demo --create-namespace --version=v0.1.0 --values values.yaml
```
