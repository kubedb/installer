...
$ helm repo update
$ helm search repo appscode/kubedb-opscenter --version=v2023.04.10
$ helm upgrade -i kubedb-opscenter appscode/kubedb-opscenter -n kubedb --create-namespace --version=v2023.04.10
```
...
```bash
$ helm upgrade -i kubedb-opscenter appscode/kubedb-opscenter -n kubedb --create-namespace --version=v2023.04.10 --set global.registryFQDN=ghcr.io
```
...
```bash
$ helm upgrade -i kubedb-opscenter appscode/kubedb-opscenter -n kubedb --create-namespace --version=v2023.04.10 --values values.yaml
```
