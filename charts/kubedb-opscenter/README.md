...
$ helm repo update
$ helm search repo appscode/kubedb-opscenter --version=v2025.7.30-rc.0
$ helm upgrade -i kubedb-opscenter appscode/kubedb-opscenter -n kubedb --create-namespace --version=v2025.7.30-rc.0
```
...
```bash
$ helm upgrade -i kubedb-opscenter appscode/kubedb-opscenter -n kubedb --create-namespace --version=v2025.7.30-rc.0 --set global.registryFQDN=ghcr.io
```
...
```bash
$ helm upgrade -i kubedb-opscenter appscode/kubedb-opscenter -n kubedb --create-namespace --version=v2025.7.30-rc.0 --values values.yaml
```
