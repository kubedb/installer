...
$ helm repo update
$ helm search repo appscode/kubedb-opscenter --version=v2024.3.16
$ helm upgrade -i kubedb-opscenter appscode/kubedb-opscenter -n kubedb --create-namespace --version=v2024.3.16
```
...
```bash
$ helm upgrade -i kubedb-opscenter appscode/kubedb-opscenter -n kubedb --create-namespace --version=v2024.3.16 --set global.registryFQDN=ghcr.io
```
...
```bash
$ helm upgrade -i kubedb-opscenter appscode/kubedb-opscenter -n kubedb --create-namespace --version=v2024.3.16 --values values.yaml
```
