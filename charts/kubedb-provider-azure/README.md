...
$ helm repo update
$ helm search repo appscode/kubedb-provider-azure --version=v2026.8.26-rc.2
$ helm upgrade -i kubedb-provider-azure appscode/kubedb-provider-azure -n crossplane-system --create-namespace --version=v2026.8.26-rc.2
```
...
```bash
$ helm upgrade -i kubedb-provider-azure appscode/kubedb-provider-azure -n crossplane-system --create-namespace --version=v2026.8.26-rc.2 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-provider-azure appscode/kubedb-provider-azure -n crossplane-system --create-namespace --version=v2026.8.26-rc.2 --values values.yaml
```
