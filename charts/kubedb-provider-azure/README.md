...
$ helm repo update
$ helm search repo appscode/kubedb-provider-azure --version=v2026.4.13-rc.0
$ helm upgrade -i kubedb-provider-azure appscode/kubedb-provider-azure -n crossplane-system --create-namespace --version=v2026.4.13-rc.0
```
...
```bash
$ helm upgrade -i kubedb-provider-azure appscode/kubedb-provider-azure -n crossplane-system --create-namespace --version=v2026.4.13-rc.0 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-provider-azure appscode/kubedb-provider-azure -n crossplane-system --create-namespace --version=v2026.4.13-rc.0 --values values.yaml
```
