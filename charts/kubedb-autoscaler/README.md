...
$ helm repo update
$ helm search repo appscode/kubedb-autoscaler --version=v0.13.0-rc.0
$ helm upgrade -i kubedb-autoscaler appscode/kubedb-autoscaler -n kubedb --create-namespace --version=v0.13.0-rc.0
```
...
```bash
$ helm upgrade -i kubedb-autoscaler appscode/kubedb-autoscaler -n kubedb --create-namespace --version=v0.13.0-rc.0 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-autoscaler appscode/kubedb-autoscaler -n kubedb --create-namespace --version=v0.13.0-rc.0 --values values.yaml
```
