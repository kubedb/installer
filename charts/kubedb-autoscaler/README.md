...
$ helm repo update
$ helm search repo appscode/kubedb-autoscaler --version=v0.15.0-rc.1
$ helm upgrade -i kubedb-autoscaler appscode/kubedb-autoscaler -n kubedb --create-namespace --version=v0.15.0-rc.1
```
...
```bash
$ helm upgrade -i kubedb-autoscaler appscode/kubedb-autoscaler -n kubedb --create-namespace --version=v0.15.0-rc.1 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-autoscaler appscode/kubedb-autoscaler -n kubedb --create-namespace --version=v0.15.0-rc.1 --values values.yaml
```
