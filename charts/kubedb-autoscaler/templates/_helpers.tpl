...
*/}}
{{- define "kubedb-autoscaler.fullname" -}}
...
*/}}
{{- define "kubedb-autoscaler.chart" -}}
...
Common labels
*/}}
{{- define "kubedb-autoscaler.labels" -}}
helm.sh/chart: {{ include "kubedb-autoscaler.chart" . }}
{{ include "kubedb-autoscaler.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "kubedb-autoscaler.selectorLabels" -}}
app.kubernetes.io/name: {{ include "kubedb-autoscaler.name" . }}
...
*/}}
{{- define "kubedb-autoscaler.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "kubedb-autoscaler.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
{{- default (printf "%s-license" (include "kubedb-autoscaler.fullname" .)) .Values.licenseSecretName }}
{{- end }}
