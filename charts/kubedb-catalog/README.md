...
$ helm repo update
$ helm search repo appscode/kubedb-catalog --version=v2023.08.18
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2023.08.18
```
...
```bash
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2023.08.18 --values values.yaml
```
