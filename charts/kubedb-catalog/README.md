...
$ helm repo update
$ helm search repo appscode/kubedb-catalog --version=v2026.2.26
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2026.2.26
```
...
```bash
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2026.2.26 --values values.yaml
```
