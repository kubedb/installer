...
$ helm repo update
$ helm search repo appscode/kubedb-catalog --version=v2024.9.30
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2024.9.30
```
...
```bash
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2024.9.30 --set proxies.ghcr=ghcr.io
```
...
```bash
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2024.9.30 --values values.yaml
```
