...
$ helm repo update
$ helm search repo appscode/kubedb-catalog --version=v2026.6.18-rc.2
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2026.6.18-rc.2
```
...
```bash
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2026.6.18-rc.2 --set proxies.dockerHub=docker.io
```
...
```bash
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2026.6.18-rc.2 --values values.yaml
```
