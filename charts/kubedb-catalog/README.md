...
$ helm repo update
$ helm search repo appscode/kubedb-catalog --version=v2025.2.6-rc.0
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2025.2.6-rc.0
```
...
```bash
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2025.2.6-rc.0 --set proxies.ghcr=ghcr.io
```
...
```bash
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2025.2.6-rc.0 --values values.yaml
```
