...
$ helm repo update
$ helm search repo appscode/kubedb-catalog --version=v2022.08.02-rc.0
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2022.08.02-rc.0
```
...
```bash
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2022.08.02-rc.0 --set -- generate from values file --
```
...
```bash
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2022.08.02-rc.0 --values values.yaml
```
