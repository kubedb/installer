...
$ helm repo update
$ helm search repo appscode/kubedb-catalog --version=v2026.4.27
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2026.4.27
```
...
```bash
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2026.4.27 --set proxies.dockerHub=docker.io
```
...
```bash
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2026.4.27 --values values.yaml
```
