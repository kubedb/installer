...
$ helm repo update
$ helm search repo appscode/kubedb-catalog --version=v2026.8.26-rc.2
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2026.8.26-rc.2
```
...
| disableVersions.Aerospike                  |                                                 | <code>[]</code>                            |
| disableVersions.Druid                      |                                                 | <code>[]</code>                            |
| disableVersions.Elasticsearch              |                                                 | <code>[]</code>                            |
| disableVersions.Hazelcast                  |                                                 | <code>[]</code>                            |
| disableVersions.Ignite                     |                                                 | <code>[]</code>                            |
| disableVersions.Kafka                      |                                                 | <code>[]</code>                            |
| disableVersions.MariaDB                    |                                                 | <code>[]</code>                            |
| disableVersions.Memcached                  |                                                 | <code>[]</code>                            |
| disableVersions.Milvus                     |                                                 | <code>[]</code>                            |
| disableVersions.MSSQLServer                |                                                 | <code>[]</code>                            |
| disableVersions.MongoDB                    |                                                 | <code>[]</code>                            |
| disableVersions.MySQL                      |                                                 | <code>[]</code>                            |
| disableVersions.Oracle                     |                                                 | <code>[]</code>                            |
| disableVersions.PerconaXtraDB              |                                                 | <code>[]</code>                            |
| disableVersions.PgBouncer                  |                                                 | <code>[]</code>                            |
| disableVersions.Pgpool                     |                                                 | <code>[]</code>                            |
| disableVersions.Postgres                   |                                                 | <code>[]</code>                            |
| disableVersions.ProxySQL                   |                                                 | <code>[]</code>                            |
| disableVersions.Qdrant                     |                                                 | <code>[]</code>                            |
| disableVersions.RabbitMQ                   |                                                 | <code>[]</code>                            |
| disableVersions.Redis                      |                                                 | <code>[]</code>                            |
| disableVersions.Singlestore                |                                                 | <code>[]</code>                            |
| disableVersions.Solr                       |                                                 | <code>[]</code>                            |
| disableVersions.ZooKeeper                  |                                                 | <code>[]</code>                            |
| disableVersions.Weaviate                   |                                                 | <code>[]</code>                            |
...
```bash
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2026.8.26-rc.2 --set proxies.dockerHub=docker.io
```
...
```bash
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2026.8.26-rc.2 --values values.yaml
```
