...
$ helm repo update
$ helm search repo appscode/kubedb-catalog --version=v2025.12.31-rc.1
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2025.12.31-rc.1
```
...
```bash
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2025.12.31-rc.1 --set proxies.ghcr=ghcr.io
```
...
```bash
$ helm upgrade -i kubedb-catalog appscode/kubedb-catalog -n kubedb --create-namespace --version=v2025.12.31-rc.1 --values values.yaml
```
