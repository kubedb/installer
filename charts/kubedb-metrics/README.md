...
$ helm repo update
$ helm search repo appscode/kubedb-metrics --version=v2026.2.26
$ helm upgrade -i kubedb-metrics appscode/kubedb-metrics -n kubedb --create-namespace --version=v2026.2.26
```
...
```bash
$ helm upgrade -i kubedb-metrics appscode/kubedb-metrics -n kubedb --create-namespace --version=v2026.2.26 --set -- generate from values file --
```
...
```bash
$ helm upgrade -i kubedb-metrics appscode/kubedb-metrics -n kubedb --create-namespace --version=v2026.2.26 --values values.yaml
```
