...
$ helm repo update
$ helm search repo appscode/kubedb-metrics --version=v2026.6.18-rc.2
$ helm upgrade -i kubedb-metrics appscode/kubedb-metrics -n kubedb --create-namespace --version=v2026.6.18-rc.2
```
...
```bash
$ helm upgrade -i kubedb-metrics appscode/kubedb-metrics -n kubedb --create-namespace --version=v2026.6.18-rc.2 --set -- generate from values file --
```
...
```bash
$ helm upgrade -i kubedb-metrics appscode/kubedb-metrics -n kubedb --create-namespace --version=v2026.6.18-rc.2 --values values.yaml
```
