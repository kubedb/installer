...
$ helm repo update
$ helm search repo appscode/kubedb-metrics --version=v2026.2.16-rc.0
$ helm upgrade -i kubedb-metrics appscode/kubedb-metrics -n kubedb --create-namespace --version=v2026.2.16-rc.0
```
...
```bash
$ helm upgrade -i kubedb-metrics appscode/kubedb-metrics -n kubedb --create-namespace --version=v2026.2.16-rc.0 --set -- generate from values file --
```
...
```bash
$ helm upgrade -i kubedb-metrics appscode/kubedb-metrics -n kubedb --create-namespace --version=v2026.2.16-rc.0 --values values.yaml
```
