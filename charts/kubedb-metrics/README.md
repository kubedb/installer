...
$ helm repo update
$ helm search repo appscode/kubedb-metrics --version=v2026.2.21-rc.1
$ helm upgrade -i kubedb-metrics appscode/kubedb-metrics -n kubedb --create-namespace --version=v2026.2.21-rc.1
```
...
```bash
$ helm upgrade -i kubedb-metrics appscode/kubedb-metrics -n kubedb --create-namespace --version=v2026.2.21-rc.1 --set -- generate from values file --
```
...
```bash
$ helm upgrade -i kubedb-metrics appscode/kubedb-metrics -n kubedb --create-namespace --version=v2026.2.21-rc.1 --values values.yaml
```
