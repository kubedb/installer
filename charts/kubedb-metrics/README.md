...
$ helm repo update
$ helm search repo appscode/kubedb-metrics --version=v2025.7.31
$ helm upgrade -i kubedb-metrics appscode/kubedb-metrics -n kubedb --create-namespace --version=v2025.7.31
```
