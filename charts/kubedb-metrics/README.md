...
$ helm repo update
$ helm search repo appscode/kubedb-metrics --version=v2024.8.2-rc.2
$ helm upgrade -i kubedb-metrics appscode/kubedb-metrics -n kubedb --create-namespace --version=v2024.8.2-rc.2
```
