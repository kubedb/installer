...
$ helm repo update
$ helm search repo appscode/kubedb-metrics --version=v2026.7.10
$ helm upgrade -i kubedb-metrics appscode/kubedb-metrics -n kubedb --create-namespace --version=v2026.7.10
```
...
```bash
$ helm upgrade -i kubedb-metrics appscode/kubedb-metrics -n kubedb --create-namespace --version=v2026.7.10 --set -- generate from values file --
```
...
```bash
$ helm upgrade -i kubedb-metrics appscode/kubedb-metrics -n kubedb --create-namespace --version=v2026.7.10 --values values.yaml
```
