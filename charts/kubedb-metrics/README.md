...
$ helm repo update
$ helm search repo appscode/kubedb-metrics --version=v2022.10.12-rc.0
$ helm upgrade -i kubedb-metrics appscode/kubedb-metrics -n kubedb --create-namespace --version=v2022.10.12-rc.0
```
