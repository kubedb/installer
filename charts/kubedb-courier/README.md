...
$ helm repo update
$ helm search repo appscode/kubedb-courier --version=v0.6.0
$ helm upgrade -i kubedb-courier appscode/kubedb-courier -n kubedb --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i kubedb-courier appscode/kubedb-courier -n kubedb --create-namespace --version=v0.6.0 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-courier appscode/kubedb-courier -n kubedb --create-namespace --version=v0.6.0 --values values.yaml
```
