...
$ helm repo update
$ helm search repo appscode/dbgate --version=v0.1.0
$ helm upgrade -i dbgate appscode/dbgate -n demo --create-namespace --version=v0.1.0
```
...
```bash
$ helm upgrade -i dbgate appscode/dbgate -n demo --create-namespace --version=v0.1.0 --set image.tag=latest
```
...
```bash
$ helm upgrade -i dbgate appscode/dbgate -n demo --create-namespace --version=v0.1.0 --values values.yaml
```
