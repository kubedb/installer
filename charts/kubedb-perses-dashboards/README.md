...
$ helm repo update
$ helm search repo appscode/kubedb-perses-dashboards --version=v2025.12.31-rc.1
$ helm upgrade -i kubedb-perses-dashboards appscode/kubedb-perses-dashboards -n kubeops --create-namespace --version=v2025.12.31-rc.1
```
...
```bash
$ helm upgrade -i kubedb-perses-dashboards appscode/kubedb-perses-dashboards -n kubeops --create-namespace --version=v2025.12.31-rc.1 --set resources=["elasticsearch","kafka","mariadb","mongodb","mysql","postgres","redis"]
```
...
```bash
$ helm upgrade -i kubedb-perses-dashboards appscode/kubedb-perses-dashboards -n kubeops --create-namespace --version=v2025.12.31-rc.1 --values values.yaml
```
