...
$ helm repo update
$ helm search repo appscode/pgadmin --version=v0.1.0
$ helm upgrade -i pgadmin appscode/pgadmin -n demo --create-namespace --version=v0.1.0
```
...
```bash
$ helm upgrade -i pgadmin appscode/pgadmin -n demo --create-namespace --version=v0.1.0 --set image.tag=latest
```
...
```bash
$ helm upgrade -i pgadmin appscode/pgadmin -n demo --create-namespace --version=v0.1.0 --values values.yaml
```
