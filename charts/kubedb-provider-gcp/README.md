...
$ helm repo update
$ helm search repo appscode/kubedb-provider-gcp --version=v2025.10.17
$ helm upgrade -i kubedb-provider-gcp appscode/kubedb-provider-gcp -n crossplane-system --create-namespace --version=v2025.10.17
```
...
```bash
$ helm upgrade -i kubedb-provider-gcp appscode/kubedb-provider-gcp -n crossplane-system --create-namespace --version=v2025.10.17 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-provider-gcp appscode/kubedb-provider-gcp -n crossplane-system --create-namespace --version=v2025.10.17 --values values.yaml
```
