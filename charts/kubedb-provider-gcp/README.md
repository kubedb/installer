...
$ helm repo update
$ helm search repo appscode/kubedb-provider-gcp --version=v2025.1.9
$ helm upgrade -i kubedb-provider-gcp appscode/kubedb-provider-gcp -n crossplane-system --create-namespace --version=v2025.1.9
```
...
```bash
$ helm upgrade -i kubedb-provider-gcp appscode/kubedb-provider-gcp -n crossplane-system --create-namespace --version=v2025.1.9 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-provider-gcp appscode/kubedb-provider-gcp -n crossplane-system --create-namespace --version=v2025.1.9 --values values.yaml
```
