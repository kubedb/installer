...
$ helm repo update
$ helm search repo appscode/kubedb-provider-gcp --version=v2024.3.9-rc.0
$ helm upgrade -i kubedb-provider-gcp appscode/kubedb-provider-gcp -n crossplane-system --create-namespace --version=v2024.3.9-rc.0
```
...
```bash
$ helm upgrade -i kubedb-provider-gcp appscode/kubedb-provider-gcp -n crossplane-system --create-namespace --version=v2024.3.9-rc.0 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-provider-gcp appscode/kubedb-provider-gcp -n crossplane-system --create-namespace --version=v2024.3.9-rc.0 --values values.yaml
```
