...
$ helm repo update
$ helm search repo appscode/kubedb-provider-gcp --version=v2023.12.11
...
```bash
$ helm upgrade -i kubedb-provider-gcp appscode/kubedb-provider-gcp -n crossplane-system --create-namespace --version=v2023.12.11 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-provider-gcp appscode/kubedb-provider-gcp -n crossplane-system --create-namespace --version=v2023.12.11 --values values.yaml
```
