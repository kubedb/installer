...
$ helm repo update
$ helm search repo appscode/kubedb-provider-gcp --version=v2026.6.5-rc.1
$ helm upgrade -i kubedb-provider-gcp appscode/kubedb-provider-gcp -n crossplane-system --create-namespace --version=v2026.6.5-rc.1
```
...
```bash
$ helm upgrade -i kubedb-provider-gcp appscode/kubedb-provider-gcp -n crossplane-system --create-namespace --version=v2026.6.5-rc.1 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-provider-gcp appscode/kubedb-provider-gcp -n crossplane-system --create-namespace --version=v2026.6.5-rc.1 --values values.yaml
```
