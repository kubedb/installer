...
$ helm repo update
$ helm search repo appscode/kubedb-schema-manager --version=v0.6.0-rc.1
$ helm upgrade -i kubedb-schema-manager appscode/kubedb-schema-manager -n kubedb --create-namespace --version=v0.6.0-rc.1
```
...
```bash
$ helm upgrade -i kubedb-schema-manager appscode/kubedb-schema-manager -n kubedb --create-namespace --version=v0.6.0-rc.1 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-schema-manager appscode/kubedb-schema-manager -n kubedb --create-namespace --version=v0.6.0-rc.1 --values values.yaml
```
