...
$ helm repo update
$ helm search repo appscode/kubedb --version=v2022.05.24
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2022.05.24
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2022.05.24 --set global.registry=kubedb
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2022.05.24 --values values.yaml
```
