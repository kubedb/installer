...
$ helm repo update
$ helm search repo appscode/kubedb --version=v2022.10.12-rc.0
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2022.10.12-rc.0
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2022.10.12-rc.0 --set global.registry=kubedb
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2022.10.12-rc.0 --values values.yaml
```
