...
$ helm repo update
$ helm search repo appscode/kubedb --version=v2023.11.2
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2023.11.2
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2023.11.2 --set global.registry=kubedb
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2023.11.2 --values values.yaml
```
