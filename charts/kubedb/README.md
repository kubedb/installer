...
$ helm repo update
$ helm search repo appscode/kubedb --version=v2022.12.24-rc.1
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2022.12.24-rc.1
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2022.12.24-rc.1 --set global.registry=kubedb
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2022.12.24-rc.1 --values values.yaml
```
