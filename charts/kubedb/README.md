...
$ helm repo update
$ helm search repo appscode/kubedb --version=v2022.12.28
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2022.12.28
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2022.12.28 --set global.registry=kubedb
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2022.12.28 --values values.yaml
```
