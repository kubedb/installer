...
$ helm repo update
$ helm search repo appscode/kubedb --version=v2022.08.08
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2022.08.08
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2022.08.08 --set global.registry=kubedb
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2022.08.08 --values values.yaml
```
