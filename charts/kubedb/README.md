...
$ helm repo update
$ helm search repo appscode/kubedb --version=v2023.12.21
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2023.12.21
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2023.12.21 --set global.registry=kubedb
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2023.12.21 --values values.yaml
```
