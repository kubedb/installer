...
$ helm repo update
$ helm search repo appscode/kubedb --version=v2023.06.19
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2023.06.19
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2023.06.19 --set global.registry=kubedb
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2023.06.19 --values values.yaml
```
