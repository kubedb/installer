...
$ helm repo update
$ helm search repo appscode/kubedb --version=v2022.10.18
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2022.10.18
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2022.10.18 --set global.registry=kubedb
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2022.10.18 --values values.yaml
```
