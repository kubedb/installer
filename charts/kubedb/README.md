...
$ helm repo update
$ helm search repo appscode/kubedb --version=v2023.10.9
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2023.10.9
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2023.10.9 --set global.registry=kubedb
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kubedb --create-namespace --version=v2023.10.9 --values values.yaml
```
