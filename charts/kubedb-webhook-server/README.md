...
$ helm repo update
$ helm search repo appscode/kubedb-webhook-server --version=v0.10.0-rc.0
$ helm upgrade -i kubedb-webhook-server appscode/kubedb-webhook-server -n kubedb --create-namespace --version=v0.10.0-rc.0
```
...
```bash
$ helm upgrade -i kubedb-webhook-server appscode/kubedb-webhook-server -n kubedb --create-namespace --version=v0.10.0-rc.0 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-webhook-server appscode/kubedb-webhook-server -n kubedb --create-namespace --version=v0.10.0-rc.0 --values values.yaml
```
