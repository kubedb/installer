...
$ helm repo update
$ helm search repo appscode/kubedb-provider-aws --version=v2026.7.10
$ helm upgrade -i kubedb-provider-aws appscode/kubedb-provider-aws -n crossplane-system --create-namespace --version=v2026.7.10
```
...
```bash
$ helm upgrade -i kubedb-provider-aws appscode/kubedb-provider-aws -n crossplane-system --create-namespace --version=v2026.7.10 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-provider-aws appscode/kubedb-provider-aws -n crossplane-system --create-namespace --version=v2026.7.10 --values values.yaml
```
