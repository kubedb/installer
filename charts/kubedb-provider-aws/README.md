...
$ helm repo update
$ helm search repo appscode/kubedb-provider-aws --version=v2026.8.26-rc.2
$ helm upgrade -i kubedb-provider-aws appscode/kubedb-provider-aws -n crossplane-system --create-namespace --version=v2026.8.26-rc.2
```
...
```bash
$ helm upgrade -i kubedb-provider-aws appscode/kubedb-provider-aws -n crossplane-system --create-namespace --version=v2026.8.26-rc.2 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-provider-aws appscode/kubedb-provider-aws -n crossplane-system --create-namespace --version=v2026.8.26-rc.2 --values values.yaml
```
