...
$ helm repo update
$ helm search repo appscode/kubedb-provider-aws --version=v2024.8.14-rc.3
$ helm upgrade -i kubedb-provider-aws appscode/kubedb-provider-aws -n crossplane-system --create-namespace --version=v2024.8.14-rc.3
```
...
```bash
$ helm upgrade -i kubedb-provider-aws appscode/kubedb-provider-aws -n crossplane-system --create-namespace --version=v2024.8.14-rc.3 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-provider-aws appscode/kubedb-provider-aws -n crossplane-system --create-namespace --version=v2024.8.14-rc.3 --values values.yaml
```
