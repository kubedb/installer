...
$ helm repo update
$ helm search repo appscode/kubedb-provider-aws --version=v2025.2.6-rc.0
$ helm upgrade -i kubedb-provider-aws appscode/kubedb-provider-aws -n crossplane-system --create-namespace --version=v2025.2.6-rc.0
```
...
```bash
$ helm upgrade -i kubedb-provider-aws appscode/kubedb-provider-aws -n crossplane-system --create-namespace --version=v2025.2.6-rc.0 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-provider-aws appscode/kubedb-provider-aws -n crossplane-system --create-namespace --version=v2025.2.6-rc.0 --values values.yaml
```
