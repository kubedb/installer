...
*/}}
{{- define "kubedb-provisioner.name" -}}
...
*/}}
{{- define "kubedb-provisioner.fullname" -}}
...
*/}}
{{- define "kubedb-provisioner.chart" -}}
...
Common labels
*/}}
{{- define "kubedb-provisioner.labels" -}}
helm.sh/chart: {{ include "kubedb-provisioner.chart" . }}
{{ include "kubedb-provisioner.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "kubedb-provisioner.selectorLabels" -}}
app.kubernetes.io/name: {{ include "kubedb-provisioner.name" . }}
...
*/}}
{{- define "kubedb-provisioner.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "kubedb-provisioner.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
{{- default (printf "%s-license" (include "kubedb-provisioner.fullname" .)) .Values.licenseSecretName }}
{{- end }}
