...
$ helm repo update
$ helm search repo appscode/kubedb-provisioner --version=v0.28.0-rc.0
$ helm upgrade -i kubedb-provisioner appscode/kubedb-provisioner -n kubedb --create-namespace --version=v0.28.0-rc.0
```
...
```bash
$ helm upgrade -i kubedb-provisioner appscode/kubedb-provisioner -n kubedb --create-namespace --version=v0.28.0-rc.0 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-provisioner appscode/kubedb-provisioner -n kubedb --create-namespace --version=v0.28.0-rc.0 --values values.yaml
```
