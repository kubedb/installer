...
$ helm repo update
$ helm search repo appscode/kubedb-provisioner --version=v0.29.0
$ helm upgrade -i kubedb-provisioner appscode/kubedb-provisioner -n kubedb --create-namespace --version=v0.29.0
```
...
```bash
$ helm upgrade -i kubedb-provisioner appscode/kubedb-provisioner -n kubedb --create-namespace --version=v0.29.0 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-provisioner appscode/kubedb-provisioner -n kubedb --create-namespace --version=v0.29.0 --values values.yaml
```
