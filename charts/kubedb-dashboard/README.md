...
$ helm repo update
$ helm search repo appscode/kubedb-dashboard --version=v0.4.0
$ helm upgrade -i kubedb-dashboard appscode/kubedb-dashboard -n kubedb --create-namespace --version=v0.4.0
```
...
```bash
$ helm upgrade -i kubedb-dashboard appscode/kubedb-dashboard -n kubedb --create-namespace --version=v0.4.0 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-dashboard appscode/kubedb-dashboard -n kubedb --create-namespace --version=v0.4.0 --values values.yaml
```
