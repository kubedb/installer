...
*/}}
{{- define "kubedb-dashboard.fullname" -}}
...
Common labels
*/}}
{{- define "kubedb-dashboard.labels" -}}
helm.sh/chart: {{ include "kubedb-dashboard.chart" . }}
{{ include "kubedb-dashboard.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "kubedb-dashboard.selectorLabels" -}}
app.kubernetes.io/name: {{ include "kubedb-dashboard.name" . }}
...
*/}}
{{- define "kubedb-dashboard.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "kubedb-dashboard.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
{{- default (printf "%s-license" (include "kubedb-dashboard.fullname" .)) .Values.licenseSecretName }}
{{- end }}
