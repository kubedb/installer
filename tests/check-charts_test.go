...
func Test_CheckImageArchitectures(t *testing.T) {
	...
	if err := lib.CheckImageArchitectures([]string{
		...
		"ghcr.io/appscode-images/postgres-documentdb:15-0.102.0-ferretdb-2.0.0-rc.5",
		"ghcr.io/appscode-images/postgres-documentdb:16-0.102.0-ferretdb-2.0.0-rc.5",
		"ghcr.io/appscode-images/postgres-documentdb:17-0.102.0-ferretdb-2.0.0-rc.5",
