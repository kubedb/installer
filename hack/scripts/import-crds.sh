...
api_repo_tag=${KUBEDB_APIMACHINERY_TAG:-fdb}
...
KMODULES_RESOURCE_METADATA_TAG=${KMODULES_RESOURCE_METADATA_TAG:-v0.26.1}
...
KUBESTASH_APIMACHINERY_TAG=${KUBESTASH_APIMACHINERY_TAG:-v0.17.0-rc.0}
