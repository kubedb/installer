...
api_repo_tag=${KUBEDB_APIMACHINERY_TAG:-oracle}
...
KMODULES_RESOURCE_METADATA_TAG=${KMODULES_RESOURCE_METADATA_TAG:-v0.28.2}
...
KUBESTASH_APIMACHINERY_TAG=${KUBESTASH_APIMACHINERY_TAG:-v0.18.1}
