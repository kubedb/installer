...
func (_ QdrantVersion) CustomResourceDefinition() *apiextensions.CustomResourceDefinition {
...
func (m QdrantVersion) ResourceFQN() string {
	return fmt.Sprintf("%s.%s", ResourcePluralQdrantVersion, catalog.GroupName)
}

func (m QdrantVersion) ResourceShortCode() string {
