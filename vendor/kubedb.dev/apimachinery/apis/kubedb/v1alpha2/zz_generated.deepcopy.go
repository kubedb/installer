...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MilvusMetadataStorage) DeepCopyInto(out *MilvusMetadataStorage) {
	*out = *in
	if in.Endpoints != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MilvusMetadataStorage.
func (in *MilvusMetadataStorage) DeepCopy() *MilvusMetadataStorage {
	if in == nil {
		return nil
	}
	out := new(MilvusMetadataStorage)
	in.DeepCopyInto(out)
	return out
}
