...
func TestKubeDBEnterpriseDefaultValues(t *testing.T) {
	diffstring, err := compareKubeDBEnterpriseDefaultValues()
	if err != nil {
		t.Error(err)
	}
	if diffstring != "" {
...
func compareKubeDBEnterpriseDefaultValues() (string, error) {
	data, err := ioutil.ReadFile("../../../charts/kubedb-enterprise/values.yaml")
	if err != nil {
		return "", err
	}
	...
	var spec v1alpha1.KubeDBEnterpriseSpec
