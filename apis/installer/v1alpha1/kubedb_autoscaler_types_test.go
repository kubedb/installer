...
func TestKubeDBAutoscalerDefaultValues(t *testing.T) {
	diffstring, err := compareKubeDBAutoscalerDefaultValues()
	if err != nil {
		t.Error(err)
	}
	if diffstring != "" {
...
func compareKubeDBAutoscalerDefaultValues() (string, error) {
	data, err := ioutil.ReadFile("../../../charts/kubedb-autoscaler/values.yaml")
	if err != nil {
		return "", err
	}
	...
	var spec v1alpha1.KubeDBAutoscalerSpec
